...
for n = 1:2
    ...
    FIGOBJS.IM2.DiscardROIbutton(n) = uicontrol('Parent',FIGOBJS.IM2.ROITab(n),'Style','pushbutton','tag',num2str(n),'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String','Update','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.17 0.21 0.06 0.16],'CallBack',@ButtonUpdateValue);   
