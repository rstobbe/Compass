...
Compass = figure;
Compass.Name = ['Compass  (',169,' Rob Stobbe 2019)'];
...
for n = 1:2
    FIGOBJS.IM2.VALUElab(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Value','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.15 0.02 0.1 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM2.Xlab(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','X (mm)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.275 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM2.Ylab(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Y (mm)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.35 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM2.Zlab(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Z (mm)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.425 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM2.XPixlab(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','X (pix)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.50 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM2.YPixlab(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Y (pix)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.575 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM2.ZPixlab(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Z (pix)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.65 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM2.DIM4lab(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Dim4','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.725 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM2.DIM5lab(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Dim5','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.80 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM2.DIM6lab(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Dim6','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.875 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    ...
    FIGOBJS.IM2.CURVAL(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.155 0.005 0.07 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.X(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.280 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.Y(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.355 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.Z(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.430 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.XPix(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.505 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.YPix(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.580 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.ZPix(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.655 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.DIM4(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.730 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.DIM5(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.805 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.DIM6(n) = uicontrol('Parent',FIGOBJS.IM2.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.880 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
end
for n = 1:2
...
for m = 1:2
    for n = 1:4
        loc = [0.7 0.5 0.3 0.1];
        FIGOBJS.IM2.LoadOverlay(m,n) = uicontrol('Parent',FIGOBJS.IM2.OverlayTab(m),'Style','pushbutton','tag',[num2str(m),num2str(n)],'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String','Select','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.03 loc(n) 0.06 0.16],'CallBack',@LoadOverlay);    
        ...
        FIGOBJS.IM2.OverlayColour(m,n) = uicontrol('Parent',FIGOBJS.IM2.OverlayTab(m),'Style','popupmenu','tag',[num2str(m),num2str(n)],'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String',{'off','on'},'HorizontalAlignment','right','Fontsize',6,'Units','normalized','Position',[0.31 loc(n)+0.01 0.07 0.15],'CallBack',@OverlayColour);
        uicontrol('Parent',FIGOBJS.IM2.OverlayTab(m),'Style','text','tag',[num2str(m),num2str(n)],'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','Transparency','HorizontalAlignment','right','Fontsize',7,'Units','normalized','Position',[0.39 loc(n) 0.07 0.14],'Enable','inactive','ButtonDownFcn',@ResetFocus);
        FIGOBJS.IM2.OverlayTransparency(m,n) = uicontrol('Parent',FIGOBJS.IM2.OverlayTab(m),'Style','slider','tag',[num2str(m),num2str(n)],'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'Units','normalized','Position',[0.47 loc(n)+0.01 0.25 0.14],'Value',0.5,'CallBack',@OverlayTransparency,'SliderStep',[0.02 0.1]);
        addlistener(FIGOBJS.IM2.OverlayTransparency(m,n),'Value','PostSet',@OverlayTransparency2);
        FIGOBJS.IM2.OverlayMax(m,n) = uicontrol('Parent',FIGOBJS.IM2.OverlayTab(m),'Style','edit','tag',[num2str(m),num2str(n)],'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.73 loc(n)+0.01 0.04 0.14],'CallBack',@OverlayMaxval,'KeyPressFcn',@OverlayMaxEdit);
        FIGOBJS.IM2.OverlayMin(m,n) = uicontrol('Parent',FIGOBJS.IM2.OverlayTab(m),'Style','edit','tag',[num2str(m),num2str(n)],'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.77 loc(n)+0.01 0.04 0.14],'CallBack',@OverlayMinval,'KeyPressFcn',@OverlayMinEdit);
        FIGOBJS.IM2.OverlayValue(m,n) = uicontrol('Parent',FIGOBJS.IM2.OverlayTab(m),'Style','text','tag',[num2str(m),num2str(n)],'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String','','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.82 loc(n)+0.01 0.08 0.14],'ButtonDownFcn',@ResetFocus);
        FIGOBJS.IM2.DeleteOverlay(m,n) = uicontrol('Parent',FIGOBJS.IM2.OverlayTab(m),'Style','pushbutton','tag',[num2str(m),num2str(n)],'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String','Delete','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.91 loc(n) 0.06 0.16],'CallBack',@DeleteOverlay);    
    end
...
for n = 1:1
    FIGOBJS.IM3.VALUElab(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Value','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.15 0.02 0.1 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM3.Xlab(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','X (mm)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.275 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM3.Ylab(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Y (mm)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.35 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM3.Zlab(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Z (mm)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.425 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM3.XPixlab(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','X (pix)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.50 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM3.YPixlab(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Y (pix)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.575 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM3.ZPixlab(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Z (pix)','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.65 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM3.DIM4lab(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Dim4','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.725 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM3.DIM5lab(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Dim5','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.80 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    FIGOBJS.IM3.DIM6lab(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[0.8 0.8 0.8],'String','Dim6','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.875 0.02 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus,'Visible','Off');
    ...
    FIGOBJS.IM3.CURVAL(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.155 0.005 0.07 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.X(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.280 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.Y(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.355 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.Z(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.430 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.XPix(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.505 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.YPix(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.580 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.ZPix(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.655 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.DIM4(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.730 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.DIM5(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.805 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.DIM6(n) = uicontrol('Parent',FIGOBJS.IM3.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.880 0.005 0.05 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
end   
for n = 1:1
...
for n = 1:4
    loc = [0.7 0.5 0.3 0.1];
    FIGOBJS.IM3.LoadOverlay(1,n) = uicontrol('Parent',FIGOBJS.IM3.OverlayTab(1),'Style','pushbutton','tag',[num2str(1),num2str(n)],'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String','Select','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.03 loc(n) 0.06 0.16],'CallBack',@LoadOverlay);    
    ...
    FIGOBJS.IM3.OverlayColour(1,n) = uicontrol('Parent',FIGOBJS.IM3.OverlayTab(1),'Style','popupmenu','tag',[num2str(1),num2str(n)],'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String',{'off','on'},'HorizontalAlignment','right','Fontsize',6,'Units','normalized','Position',[0.31 loc(n)+0.01 0.07 0.15],'CallBack',@OverlayColour);
    uicontrol('Parent',FIGOBJS.IM3.OverlayTab(1),'Style','text','tag',[num2str(1),num2str(n)],'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','Transparency','HorizontalAlignment','right','Fontsize',7,'Units','normalized','Position',[0.39 loc(n) 0.07 0.14],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.OverlayTransparency(1,n) = uicontrol('Parent',FIGOBJS.IM3.OverlayTab(1),'Style','slider','tag',[num2str(1),num2str(n)],'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'Units','normalized','Position',[0.47 loc(n)+0.01 0.25 0.14],'Value',0.5,'CallBack',@OverlayTransparency,'SliderStep',[0.02 0.1]);
    ...
    FIGOBJS.IM3.OverlayValue(1,n) = uicontrol('Parent',FIGOBJS.IM3.OverlayTab(1),'Style','text','tag',[num2str(1),num2str(n)],'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String','','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.82 loc(n)+0.01 0.08 0.14],'ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.DeleteOverlay(1,n) = uicontrol('Parent',FIGOBJS.IM3.OverlayTab(1),'Style','pushbutton','tag',[num2str(1),num2str(n)],'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String','Delete','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.91 loc(n) 0.06 0.16],'CallBack',@DeleteOverlay);    
end
