...
for n = 1
    ...
    FIGOBJS.IM3.OverlayMax(n) = uicontrol('Parent',FIGOBJS.IM3.OverlayTab(n),'Style','edit','tag',num2str(n),'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.59 0.45 0.04 0.14],'CallBack',@OverlayMaxval,'KeyPressFcn',@OverlayMaxEdit);
    FIGOBJS.IM3.OverlayMin(n) = uicontrol('Parent',FIGOBJS.IM3.OverlayTab(n),'Style','edit','tag',num2str(n),'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.63 0.45 0.04 0.14],'CallBack',@OverlayMinval,'KeyPressFcn',@OverlayMinEdit);
    FIGOBJS.IM3.OverlayValue(n) = uicontrol('Parent',FIGOBJS.IM3.OverlayTab(n),'Style','text','tag',num2str(n),'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.68 0.45 0.07 0.14],'ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.DeleteOverlay(n) = uicontrol('Parent',FIGOBJS.IM3.OverlayTab(n),'Style','pushbutton','tag',num2str(n),'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String','Delete','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.76 0.44 0.06 0.16],'CallBack',@DeleteOverlay);    
end
