...
function RunExtFunc2_B9(treepanipt,curpanipt,treecellarray,tab,panelnum)
...
if not(isfield(SCRPTipt(curpanipt).entrystruct,'runfunc2'))
    RWSUI.runfunc = SCRPTipt(curpanipt).entrystruct.runfunc; 
else
    RWSUI.runfunc = SCRPTipt(curpanipt).entrystruct.runfunc2;
end
