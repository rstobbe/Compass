...
for n = 1:10
    ...
    FIGOBJS.IM.ImageName(n) = uicontrol('Parent',FIGOBJS.IM.ImPan(n),'Style','text','BackgroundColor',BGcolour2,'ForegroundColor',[1,1,0.5],'String','','HorizontalAlignment','left','Fontsize',8,'Units','normalized','Position',[0.01 0.98 0.25 0.015],'Enable','inactive','ButtonDownFcn',@ResetFocus);
...
for n = 1:2
    ...
    FIGOBJS.IM2.HoldContrast(n) = uicontrol('Parent',FIGOBJS.IM2.ContrastTab(n),'Style','checkbox','tag',num2str(n),'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'Fontsize',6,'Units','normalized','Position',[0.775 0.45 0.07 0.15],'CallBack',@HoldContrastChange); 
    uicontrol('Parent',FIGOBJS.IM2.ContrastTab(n),'Style','text','BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','Tie Contrast','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.85 0.57 0.07 0.15],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.TieContrast(n) = uicontrol('Parent',FIGOBJS.IM2.ContrastTab(n),'Style','checkbox','tag',num2str(n),'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'Fontsize',6,'Units','normalized','Position',[0.875 0.45 0.07 0.15],'CallBack',@TieContrastChange);
end
...
for n = 1:2
    ...
    FIGOBJS.IM2.ROICreateSel(n) = uicontrol('Parent',FIGOBJS.IM2.ROITab(n),'Style','popupmenu','tag',num2str(n),'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String',{'FreeHand','Seed','Sphere','Circle','Tube','Rect','Box'},'HorizontalAlignment','left','Fontsize',6,'Units','normalized','Position',[0.02 0.4 0.07 0.15],'CallBack',@ChangeROICreate);  
    ...
    FIGOBJS.IM2.AndROIbutton(n) = uicontrol('Parent',FIGOBJS.IM2.ROITab(n),'Style','pushbutton','tag',num2str(n),'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String','And','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.24 0.59 0.06 0.16],'CallBack',@ButtonAndROI);    
    uicontrol('Parent',FIGOBJS.IM2.ROITab(n),'Style','text','BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','ShadeROI','HorizontalAlignment','right','Fontsize',7,'Units','normalized','Position',[0.32 0.59 0.06 0.14],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.ShadeROI(n) = uicontrol('Parent',FIGOBJS.IM2.ROITab(n),'Style','checkbox','tag',num2str(n),'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'Fontsize',6,'Units','normalized','Position',[0.385 0.6 0.07 0.14],'CallBack',@ShadeROIChange);
    FIGOBJS.IM2.ShadeROIValue(n) = uicontrol('Parent',FIGOBJS.IM2.ROITab(n),'Style','slider','Tag',num2str(n),'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'Units','normalized','Position',[0.32 0.4 0.08 0.14],'Value',0.10,'SliderStep',[0.02 0.2],'CallBack',@ShadeROISlideChange);    
    addlistener(FIGOBJS.IM2.ShadeROIValue(n),'Value','PostSet',@ShadeROISlideChange2);
    uicontrol('Parent',FIGOBJS.IM2.ROITab(n),'Style','text','BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','LinesROI','HorizontalAlignment','right','Fontsize',7,'Units','normalized','Position',[0.32 0.19 0.06 0.14],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM2.LinesROI(n) = uicontrol('Parent',FIGOBJS.IM2.ROITab(n),'Style','checkbox','tag',num2str(n),'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'Fontsize',6,'Units','normalized','Position',[0.385 0.2 0.07 0.14],'CallBack',@LinesROIChange);
end
...
for n = 1
    ...
    FIGOBJS.IM3.ROICreateSel(n) = uicontrol('Parent',FIGOBJS.IM3.ROITab(n),'Style','popupmenu','tag',num2str(n),'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String',{'FreeHand','Seed','Sphere','Circle','Tube','Rect','Box'},'HorizontalAlignment','left','Fontsize',6,'Units','normalized','Position',[0.02 0.4 0.07 0.15],'CallBack',@ChangeROICreate);    
    ...
    FIGOBJS.IM3.AndROIbutton(n) = uicontrol('Parent',FIGOBJS.IM3.ROITab(n),'Style','pushbutton','tag',num2str(n),'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'String','And','HorizontalAlignment','left','Fontsize',7,'Units','normalized','Position',[0.24 0.59 0.06 0.16],'CallBack',@ButtonAndROI);    
    uicontrol('Parent',FIGOBJS.IM3.ROITab(n),'Style','text','BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','ShadeROI','HorizontalAlignment','right','Fontsize',7,'Units','normalized','Position',[0.32 0.59 0.06 0.14],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.ShadeROI(n) = uicontrol('Parent',FIGOBJS.IM3.ROITab(n),'Style','checkbox','tag',num2str(n),'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'Fontsize',6,'Units','normalized','Position',[0.385 0.6 0.07 0.14],'CallBack',@ShadeROIChange);
    FIGOBJS.IM3.ShadeROIValue(n) = uicontrol('Parent',FIGOBJS.IM3.ROITab(n),'Style','slider','Tag',num2str(n),'BackgroundColor',[0.8 0.8 0.8],'ForegroundColor',BGcolour,'Units','normalized','Position',[0.32 0.4 0.08 0.14],'Value',0.10,'SliderStep',[0.02 0.2],'CallBack',@ShadeROISlideChange);    
    addlistener(FIGOBJS.IM3.ShadeROIValue(n),'Value','PostSet',@ShadeROISlideChange2);
    uicontrol('Parent',FIGOBJS.IM3.ROITab(n),'Style','text','BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'String','LinesROI','HorizontalAlignment','right','Fontsize',7,'Units','normalized','Position',[0.32 0.19 0.06 0.14],'Enable','inactive','ButtonDownFcn',@ResetFocus);
    FIGOBJS.IM3.LinesROI(n) = uicontrol('Parent',FIGOBJS.IM3.ROITab(n),'Style','checkbox','tag',num2str(n),'BackgroundColor',BGcolour,'ForegroundColor',[0.8 0.8 0.8],'Fontsize',6,'Units','normalized','Position',[0.385 0.2 0.07 0.14],'CallBack',@LinesROIChange);
end
