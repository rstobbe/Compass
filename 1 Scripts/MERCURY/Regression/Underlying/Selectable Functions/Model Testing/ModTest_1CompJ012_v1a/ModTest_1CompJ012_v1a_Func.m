...
function [MODTST,err] = ModTest_1CompJ012_v1a_Func(MODTST,INPUT)
...
if strcmp(Op,'Setup')
    ...
    % Test
    %---------------------------------------------    
    if not(strcmp(dist(1),'None'))
        err.flag = 1;
        err.msg = 'Compartment model must have no RQI';
        return
    end
