...
function [MODTST,err] = ModTest_2CompRqiJ0_v1a_Func(MODTST,INPUT)
...
if strcmp(Op,'Setup')
    ...
    if not(strcmp(dist(1),'Gaussian'))
        err.flag = 1;
        err.msg = 'First compartment model must have Gaussian RQI distribution';
        return
    end
