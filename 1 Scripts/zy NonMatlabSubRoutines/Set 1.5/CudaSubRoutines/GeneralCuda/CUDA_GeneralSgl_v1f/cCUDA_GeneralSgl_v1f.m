function cCUDA_GeneralSgl_v1f

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_GeneralSgl_v1f.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_GeneralSgl_v1f.obj -o CUDA_GeneralSgl_v1f.lib