function cCUDA_GeneralDM_v1c

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_GeneralDM_v1c.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_GeneralDM_v1c.obj -o CUDA_GeneralDM_v1c.lib