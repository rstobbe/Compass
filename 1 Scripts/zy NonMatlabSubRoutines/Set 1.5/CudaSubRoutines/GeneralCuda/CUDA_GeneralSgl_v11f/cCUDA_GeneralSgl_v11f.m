function cCUDA_GeneralSgl_v11f

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_GeneralSgl_v11f.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_GeneralSgl_v11f.obj -o CUDA_GeneralSgl_v11f.lib