function cCUDA_GeneralD_v1c

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_GeneralD_v1c.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_GeneralD_v1c.obj -o CUDA_GeneralD_v1c.lib