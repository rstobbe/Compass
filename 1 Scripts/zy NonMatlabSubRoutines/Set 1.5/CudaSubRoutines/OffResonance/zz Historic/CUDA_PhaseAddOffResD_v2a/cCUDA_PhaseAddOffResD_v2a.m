function cCUDA_PhaseAddOffResD_v2a

!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -c -arch sm_35 --ptxas-options="-v" CUDA_PhaseAddOffResD_v2a.cu
...
!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -lib CUDA_PhaseAddOffResD_v2a.obj -o CUDA_PhaseAddOffResD_v2a.lib