function cCUDA_PhaseAddOffRes_v2a

!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -c -arch sm_35 --ptxas-options="-v" CUDA_PhaseAddOffRes_v2a.cu
...
!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -lib CUDA_PhaseAddOffRes_v2a.obj -o CUDA_PhaseAddOffRes_v2a.lib