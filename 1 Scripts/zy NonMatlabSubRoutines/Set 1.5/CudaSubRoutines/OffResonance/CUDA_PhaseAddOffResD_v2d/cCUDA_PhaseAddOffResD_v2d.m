function cCUDA_PhaseAddOffResD_v2d

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_PhaseAddOffResD_v2d.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_PhaseAddOffResD_v2d.obj -o CUDA_PhaseAddOffResD_v2d.lib