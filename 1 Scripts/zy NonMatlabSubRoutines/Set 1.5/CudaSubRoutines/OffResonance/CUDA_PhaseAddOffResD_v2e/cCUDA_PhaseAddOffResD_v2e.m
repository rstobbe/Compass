function cCUDA_PhaseAddOffResD_v2e

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_PhaseAddOffResD_v2e.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_PhaseAddOffResD_v2e.obj -o CUDA_PhaseAddOffResD_v2e.lib