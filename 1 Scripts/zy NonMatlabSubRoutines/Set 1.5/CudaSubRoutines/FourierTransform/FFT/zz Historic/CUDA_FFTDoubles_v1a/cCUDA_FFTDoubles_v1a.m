function cCUDA_FFTDoubles_v1a

!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -c -arch sm_35 --ptxas-options="-v" CUDA_FFTDoubles_v1a.cu
...
!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -lib CUDA_FFTDoubles_v1a.obj -o CUDA_FFTDoubles_v1a.lib
