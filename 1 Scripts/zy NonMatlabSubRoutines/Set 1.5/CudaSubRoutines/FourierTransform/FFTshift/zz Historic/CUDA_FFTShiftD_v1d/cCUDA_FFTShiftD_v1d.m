function cCUDA_FFTShiftD_v1d

!"%VS120COMNTOOLS%vsvars32.bat" amd64 & nvcc -c -arch compute_35 -code sm_35 -code sm_52 --ptxas-options="-v" CUDA_FFTShiftD_v1d.cu
...
!"%VS120COMNTOOLS%vsvars32.bat" amd64 & nvcc -lib CUDA_FFTShiftD_v1d.obj -o CUDA_FFTShiftD_v1d.lib