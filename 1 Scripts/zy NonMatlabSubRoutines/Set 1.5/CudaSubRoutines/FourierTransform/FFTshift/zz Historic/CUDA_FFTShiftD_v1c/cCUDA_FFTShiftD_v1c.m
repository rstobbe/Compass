function cCUDA_FFTShiftD_v1c

!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -c -arch sm_35 --ptxas-options="-v" CUDA_FFTShiftD_v1c.cu
...
!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -lib CUDA_FFTShiftD_v1c.obj -o CUDA_FFTShiftD_v1c.lib