function cCUDA_FFTShiftD_v1e

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_FFTShiftD_v1e.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_FFTShiftD_v1e.obj -o CUDA_FFTShiftD_v1e.lib