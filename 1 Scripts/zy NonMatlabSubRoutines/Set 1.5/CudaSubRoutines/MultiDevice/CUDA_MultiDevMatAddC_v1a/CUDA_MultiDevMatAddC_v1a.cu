...
extern "C" void MultiDevMatAddC(int Dst, int Src, size_t *HGrdDat, size_t *HGrdDatTemp, int MatSize, char* Error);
...
/// Code Entry
///=====================================================
void MultiDevMatAddC(int Dst, int Src, size_t *HGrdDat, size_t *HGrdDatTemp, int MatSize, char* Error){
