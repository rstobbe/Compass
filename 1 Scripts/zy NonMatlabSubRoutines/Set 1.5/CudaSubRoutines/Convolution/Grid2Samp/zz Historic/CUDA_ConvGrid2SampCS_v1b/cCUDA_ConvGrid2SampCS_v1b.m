function cCUDA_ConvGrid2SampCS_v1b

!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -c -arch sm_35 --ptxas-options="-v" CUDA_ConvGrid2SampCS_v1b.cu
...
!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -lib CUDA_ConvGrid2SampCS_v1b.obj -o CUDA_ConvGrid2SampCS_v1b.lib