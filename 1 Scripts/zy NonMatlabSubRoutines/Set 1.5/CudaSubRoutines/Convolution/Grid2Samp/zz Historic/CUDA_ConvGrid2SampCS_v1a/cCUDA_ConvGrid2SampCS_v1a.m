function cCUDA_ConvGrid2SampCS_v1a

!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -c -arch sm_35 --ptxas-options="-v" CUDA_ConvGrid2SampCS_v1a.cu
...
!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -lib CUDA_ConvGrid2SampCS_v1a.obj -o CUDA_ConvGrid2SampCS_v1a.lib