///==========================================================
/// (v1c)
///		start - ConvSamp2GridCD2D_v1c
///==========================================================

extern "C" void ConvSamp2GridCD2Dms(size_t *HSampDatR, size_t *HSampDatI, size_t *HGrdDat, size_t *HKx, size_t *HKy, size_t *HKern, 
...
/// Code Entry
///=====================================================
void ConvSamp2GridCD2Dms(size_t *HSampDatR, size_t *HSampDatI, size_t *HGrdDat, size_t *HKx, size_t *HKy, size_t *HKern, 
							int GrdDatSz, int DatLen, int KernSz, int iKern, int chW, int VolNum, char* Error){

	double *dSDatR,*dSDatI,*dGDat,*dKx,*dKy,*dKern;
	dSDatR = (double*)(*HSampDatR+VolNum*DatLen*sizeof(double));
	dSDatI = (double*)(*HSampDatI+VolNum*DatLen*sizeof(double));
	dGDat = (double*)(*HGrdDat+VolNum*GrdDatSz*GrdDatSz*2*sizeof(double));
	dKx = (double*)*HKx;
	dKy = (double*)*HKy;	
	dKern = (double*)*HKern;	
