...
extern "C" void ConvSamp2GridSplitCSM(int Count, size_t *HSampDatC, size_t *HGrdDat, size_t *HKx, size_t *HKy, size_t *HKz, size_t *HKern, 
...
/// Code Entry
///=====================================================
void ConvSamp2GridSplitCSM(int Count, size_t *HSampDatC, size_t *HGrdDat, size_t *HKx, size_t *HKy, size_t *HKz, size_t *HKern, 
							int GrdDatSz, int DatLen, int KernSz, int iKern, int chW, int SampDatAdr, int SampDatAdrC, char* Error){
