function cCUDA_ConvSamp2GridSplitRDM_v1a

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_ConvSamp2GridSplitRDM_v1a.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_ConvSamp2GridSplitRDM_v1a.obj -o CUDA_ConvSamp2GridSplitRDM_v1a.lib