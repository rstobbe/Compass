function cCUDA_ConvSamp2GridSplitRDM_v0b

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_ConvSamp2GridSplitRDM_v0b.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_ConvSamp2GridSplitRDM_v0b.obj -o CUDA_ConvSamp2GridSplitRDM_v0b.lib