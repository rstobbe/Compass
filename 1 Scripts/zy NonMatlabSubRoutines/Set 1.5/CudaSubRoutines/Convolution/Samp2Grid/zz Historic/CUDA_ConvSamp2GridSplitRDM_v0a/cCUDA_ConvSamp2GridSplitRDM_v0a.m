function cCUDA_ConvSamp2GridSplitRDM_v0a

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_ConvSamp2GridSplitRDM_v0a.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_ConvSamp2GridSplitRDM_v0a.obj -o CUDA_ConvSamp2GridSplitRDM_v0a.lib