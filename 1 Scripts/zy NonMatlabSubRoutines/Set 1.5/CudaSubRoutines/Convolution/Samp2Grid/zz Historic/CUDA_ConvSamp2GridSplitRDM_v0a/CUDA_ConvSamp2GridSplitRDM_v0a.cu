...
extern "C" void ConvSamp2GridSplitRDM(size_t *HSampDat, size_t *HGrdDat, size_t *HKx, size_t *HKy, size_t *HKz, size_t *HKern, 
...
/// Code Entry
///=====================================================
void ConvSamp2GridSplitRDM(size_t *HSampDat, size_t *HGrdDat, size_t *HKx, size_t *HKy, size_t *HKz, size_t *HKern, 
							int GrdDatSz, int DatLen, int KernSz, int iKern, int chW, int SampDatAdr, char* Error){
    ...
    for (int n=0; n<=1; n++){	
        ...
        dSDat = (double*)(HSampDat[n]+SampDatAdr*sizeof(double));
        dGDat = (double*)HGrdDat[n];
        dKx = (double*)(HKx[n]+SampDatAdr*sizeof(double));
        dKy = (double*)(HKy[n]+SampDatAdr*sizeof(double));	
        dKz = (double*)(HKz[n]+SampDatAdr*sizeof(double));
