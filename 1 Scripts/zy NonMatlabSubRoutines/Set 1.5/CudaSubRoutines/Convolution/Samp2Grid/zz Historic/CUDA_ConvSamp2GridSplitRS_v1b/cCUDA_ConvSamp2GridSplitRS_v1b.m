function cCUDA_ConvSamp2GridSplitRS_v1b

!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -c -arch sm_35 --ptxas-options="-v" CUDA_ConvSamp2GridSplitRS_v1b.cu
...
!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -lib CUDA_ConvSamp2GridSplitRS_v1b.obj -o CUDA_ConvSamp2GridSplitRS_v1b.lib