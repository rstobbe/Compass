function cCUDA_ConvSamp2GridSplitCS_v1a

!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -c -arch sm_35 --ptxas-options="-v" CUDA_ConvSamp2GridSplitCS_v1a.cu
...
!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -lib CUDA_ConvSamp2GridSplitCS_v1a.obj -o CUDA_ConvSamp2GridSplitCS_v1a.lib