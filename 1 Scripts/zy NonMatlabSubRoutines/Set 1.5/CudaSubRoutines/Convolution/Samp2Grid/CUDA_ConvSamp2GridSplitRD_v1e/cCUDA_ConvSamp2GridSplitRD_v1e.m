function cCUDA_ConvSamp2GridSplitRD_v1e

!"%VS140VC%vcvarsall.bat" amd64 & nvcc -c -arch compute_61 -code sm_61 --ptxas-options="-v" CUDA_ConvSamp2GridSplitRD_v1e.cu
...
!"%VS140VC%vcvarsall.bat" amd64 & nvcc -lib CUDA_ConvSamp2GridSplitRD_v1e.obj -o CUDA_ConvSamp2GridSplitRD_v1e.lib