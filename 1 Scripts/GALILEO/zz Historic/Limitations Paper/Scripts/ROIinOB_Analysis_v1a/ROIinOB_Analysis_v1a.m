...
function [SCRPTipt,SCRPTGBL,err] = ROIinOB_Analysis_v1a(SCRPTipt,SCRPTGBL)
...
ROIANLZ.obroi = str2double(SCRPTGBL.CurrentTree.('ObjectROI'));
...
%---------------------------------------------
tab = SCRPTGBL.RWSUI.tab;
[OB,axnum,err] = GetROISofInterest(tab,ROIANLZ.obroi);
SCRPTGBL.RWSUI.axnum = axnum;
if err.flag
    return
end
