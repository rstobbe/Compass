...
function [OBCALC,err] = CalcManipNEISEF2PSF_v1a_Func(OBCALC,INPUT)
...
kmask = fftshift(fftn(double(1-OB.roimask)));
kmask = kmask.*tfzfbg;
SmearBg = ifftn(ifftshift(kmask));

%--
SmearIm = (1.6*SmearOb+SmearBg-1)/0.6;                      % remove this hard coding... from MS investigation
%---
