...
function [OBCALC,err] = CalcIRSNEI_ManipVOI_v1b_Func(OBCALC,INPUT)

Status2('busy','Calculate NEI and IRS.  Manipulate ROI and return mean',2);
Status2('done','',3);
