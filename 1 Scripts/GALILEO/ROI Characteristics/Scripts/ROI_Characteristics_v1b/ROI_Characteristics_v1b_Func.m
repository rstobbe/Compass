...
function [ROIANLZ,err] = ROI_Characteristics_v1b_Func(ROIANLZ,INPUT)

Status('busy','ROI Characteristics');
Status2('done','',2);
Status2('done','',3);
...
for n = 1:length(ROIS)
    ...
    ROIANLZ.ExpDisp = [ROIANLZ.ExpDisp,char(13),ROIS(n).roiname,char(13),CALC.ExpDisp];
