...
function [SCRPTipt,SCRPTGBL,err] = ROI_Analysis_v1b(SCRPTipt,SCRPTGBL)
...
ROIANLZ.imloadfunc = SCRPTGBL.CurrentTree.('ImageLoadfunc').Func;
...
IMLOADipt = SCRPTGBL.CurrentTree.('ImageLoadfunc');
if isfield(SCRPTGBL,('ImageLoadfunc_Data'))
    IMLOADipt.ImageLoadfunc_Data = SCRPTGBL.ImageLoadfunc_Data;
end
...
func = str2func(ROIANLZ.imloadfunc);           
[SCRPTipt,SCRPTGBL,IMLOAD,err] = func(SCRPTipt,SCRPTGBL,IMLOADipt);
if err.flag
    return
end
