...
function [default] = DesMeth_TpiSmoothOptions_v1a_Default2(SCRPTPATHS)
...
tpitypefunc = 'TpiType_SampDensDesign_v1d';
desoltimfunc = 'DeSolTim_TpiManual_v1d';
testfunc = 'DesTest_TpiGslew_v1a';
