%====================================================
% (v1e)
%   - as TpiType_SampDensDesign_v1e
%====================================================

function [SCRPTipt,TPIT,err] = TpiType_SampDensDesignFiddle_v1e(SCRPTipt,TPITipt)
...
TPIT.wconstrain = str2double(TPITipt.('WConstrain'));
