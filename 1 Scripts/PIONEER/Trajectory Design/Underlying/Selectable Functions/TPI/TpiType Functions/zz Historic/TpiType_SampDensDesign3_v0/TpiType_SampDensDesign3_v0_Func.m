...
function [TPIT,err] = TpiType_SampDensDesign3_v1a_Func(TPIT,INPUT)

err.flag = 0;
err.msg = '';

TPIT.tpiin = @TpiSampDensDesign3_v1a;
TPIT.tpiout = @TpiSampDensDesign3_v1a;
...
% SampDensTPI
%====================================================
function dy = TpiSampDensDesign3_v1a(t,y,phi,INPUT)  
