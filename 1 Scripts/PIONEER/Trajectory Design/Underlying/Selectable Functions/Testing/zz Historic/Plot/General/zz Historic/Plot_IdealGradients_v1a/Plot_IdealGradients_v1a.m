...
function [SCRPTipt,SCRPTGBL,err] = Plot_IdealGradients_v1a(SCRPTipt,SCRPTGBL)
...
figure(350); hold on; plot(T,[G(:,1);0],'k','linewidth',1); plot([0 T(length(T))],[0 0],'k:'); xlabel('Real Time (ms)'); ylabel('x-Gradient (mT/m)');
figure(351); hold on; plot(T,[G(:,2);0],'k','linewidth',1); plot([0 T(length(T))],[0 0],'k:'); xlabel('Real Time (ms)'); ylabel('y-Gradient (mT/m)');
figure(352); hold on; plot(T,[G(:,3);0],'k','linewidth',1); plot([0 T(length(T))],[0 0],'k:'); xlabel('Real Time (ms)'); ylabel('z-Gradient (mT/m)');
