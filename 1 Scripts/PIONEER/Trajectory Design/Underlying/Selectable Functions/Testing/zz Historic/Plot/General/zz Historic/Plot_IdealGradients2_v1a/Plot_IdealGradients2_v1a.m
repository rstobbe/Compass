...
function [SCRPTipt,SCRPTGBL,err] = Plot_IdealGradients2_v1a(SCRPTipt,SCRPTGBL)
...
figure(450); hold on; plot(T(N,:),squeeze(KSA(N,:,1)),'b','linewidth',2); xlabel('Real Time (ms)'); ylabel('(1/m)'); title('x k-space');
figure(451); hold on; plot(T(N,:),squeeze(KSA(N,:,2)),'b','linewidth',2); xlabel('Real Time (ms)'); ylabel('(1/m)'); title('y k-space');
figure(452); hold on; plot(T(N,:),squeeze(KSA(N,:,3)),'b','linewidth',2); xlabel('Real Time (ms)'); ylabel('(1/m)'); title('z k-space');
