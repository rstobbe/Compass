...
function [TST,err] = DesTest_Standard_v1c_Func(TST,INPUT)
...
Panel0(4,:) = {'VoxWidCeq (mm)',PROJdgn.vox*1.24,'Output'};
Panel0(5,:) = {'Elip',PROJdgn.elip,'Output'};
Panel0(6,:) = {'VoxVolNom (mm3)',((PROJdgn.vox)^3)*(1/PROJdgn.elip),'Output'};
Panel0(7,:) = {'VoxVolCeq (mm3)',((PROJdgn.vox*1.24)^3)*(1/PROJdgn.elip),'Output'};
