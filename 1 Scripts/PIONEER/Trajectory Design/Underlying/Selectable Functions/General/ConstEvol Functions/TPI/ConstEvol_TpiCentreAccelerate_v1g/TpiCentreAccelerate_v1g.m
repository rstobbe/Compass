...
classdef TpiCentreAccelerate_v1g < handle
...
% Constructor
%---------------------------------------------
function obj = TpiCentreAccelerate_v1g(kArr,tArr,GradSlewMax,GradAccMax,PROJdgn,PROJimp,TST)
    obj.kArr = kArr;
    obj.tArr = tArr;
...
function PlotEvolutionSetup(obj)
    obj.PlotEvFigHand = figure(99003);
