...
function [CACC,err] = ConstEvol_TpiCentreAccelerate_v1i_Func(CACC,INPUT)
...
%===============================================
% function ConstEvol_TpiCentreAccelerate_v1i_Func
% 
% load('Test_20ms')
% CACC.gaccstart = 12000;
% CACC.gvelstart = 180;
% CACC.gacctransition = 5000;
% CACC.gvelreturn = 125;
% CACC.returntwk = 0.999730;
% CACC.returntwk2 = 0.999460;
% CACC.twkloc2 = 0.123;
% CACC.fracdecel = 0.10;
% 
% tArr = Test.tArr.';
...
GradSlewMax = 195;
GradAccMax = 8000;
TEVO = TpiCentreAccelerate_v1i(kArr,tArr,GradSlewMax,GradAccMax,PROJdgn,PROJimp,TST);
