...
function [CACC,err] = ConstEvol_TpiCentreAccelerate_v1h_Func(CACC,INPUT)
...
%===============================================
% function ConstEvol_TpiCentreAccelerate_v1h_Func
...
GradSlewMax = 195;
GradAccMax = 8000;
TEVO = TpiCentreAccelerate_v1h(kArr,tArr,GradSlewMax,GradAccMax,PROJdgn,PROJimp,TST);
