...
function [DESOL,err] = DeSolTim_YarnBallLookup_v1c_Func(DESOL,INPUT)
...
tic
[plout,err] = ProjLenOutside(PROJdgn.p,PROJdgn.spiralaccom,defuncOut);                    
toc
if err.flag == 1
    return
end
if strcmp(RADEV.solspeed,'rapid')
    [plin,err] = ProjLenInsideRapid(PROJdgn.p,defuncIn);     
else
...
% Rapid Inside
%===============================================================
function [projlen,err] = ProjLenInsideRapid(p,defunc)
