...
function [OUTPUT,err] = LR1_GenProj_v1i_Test1a(INPUT)
...
% DE Functions
%---------------------------------------------
defuncIn = str2func('LR1_InSol_vTest1a');
defuncOut = str2func('LR1_OutSol_vTest1a');
...
spincalcnspokesfunc = SPIN.spincalcnspokesfunc;
stheta = @(r) (pi*rad)/spincalcndiscsfunc(r);  
sphi = @(r) (2*pi*rad)/spincalcnspokesfunc(r);     
