...
function [DES,err] = TPI1a_v2f_Func(INPUT)
...
%---------------------------------------------
PROJdgn.projlenfunc = 'TPI1_pProjLen_v1a';
...
[projlen,iseg] = func(GamFunc,PROJdgn.tro,PROJdgn.p); 
PROJdgn.iseg = iseg;
...
PROJdgn.sdcTF = GAMFUNC.GamShape*PROJdgn.p;

%----------------------------------------------------
% Calculate Sampling Density
%----------------------------------------------------
SDpre = 1./(PROJdgn.r(PROJdgn.r<=PROJdgn.p).^2);
SDpost = PROJdgn.GamShape(PROJdgn.r>PROJdgn.p);
PROJdgn.SampDens = [SDpre SDpost]*PROJdgn.p*PROJdgn.projosamp;
...
%----------------------------------------------------
PSDpre = (PROJdgn.kmax^3*PROJdgn.projlen/(PROJdgn.tro*PROJdgn.GamShape(1)^2))*((PROJdgn.GamShape(PROJdgn.r<=PROJdgn.p).^2).*(PROJdgn.r(PROJdgn.r<=PROJdgn.p).^2));
PSDpost = (PROJdgn.kmax^3*PROJdgn.projlen/(PROJdgn.tro*PROJdgn.GamShape(1)^2))*PROJdgn.GamShape(PROJdgn.r>PROJdgn.p);
...
Panel(2,:) = {'iSeg (ms)',PROJdgn.iseg,'Output'};
