...
function [DES,err] = YarnBall_v1b_Func(INPUT,DES)
...
%-----------------------------------------------
% Ensure Even Distripution of Trajectories
%-----------------------------------------------
ndiscs = ceil(sqrt(PROJdgn.nproj/2));
nppd = ndiscs*2;
nprojtest = ndiscs*nppd;
if PROJdgn.nproj ~= nprojtest
    err.flag = 1;
