...
function [SOLFINTEST,err] = SolFineTest_YarnBallCompPrev_v00_Func(SOLFINTEST,INPUT)
...
INPUT.PSMP.phi = PSMP.phi(TST.traj);                    % comparison to old ('TestSet' char array selects 7 trajectories)
