%=========================================================
% (v1b)
%       - output formal tweaks
%=========================================================

function [PROJimp,GQNT,IMPipt,err] = QVec_TPI_v1b(PROJdgn,PROJimp,GQNT,IMPipt,err)
...
GQNT.samparr = [0 (GQNT.iseg:GQNT.iseg:noisegs*GQNT.iseg) (noisegs*GQNT.iseg+GQNT.twseg:GQNT.twseg:wantedtro)];
