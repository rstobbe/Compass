...
function [PROJimp,GQNT,IMPipt,err] = QVec_TPI2stpmod_v1a(PROJdgn,PROJimp,GQNT,IMPipt,err)

twGseg2Frac = str2double(IMPipt(strcmp('twGseg2Frac',{IMPipt.labelstr})).entrystr);
...
GQNT.samptwseg1 = twGseg2Frac*GQNT.twseg;
GQNT.samptwsegN = (GQNT.twseg * (twwords) - GQNT.samptwseg1)/(twwords - 1);

GQNT.samparr = [0 (GQNT.iseg:GQNT.iseg:noisegs*GQNT.iseg) noisegs*GQNT.iseg + [GQNT.samptwseg1 GQNT.samptwseg1+(GQNT.samptwsegN:GQNT.samptwsegN:wantedtro-GQNT.samptwseg1-noisegs*GQNT.iseg)]];
