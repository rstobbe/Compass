%=========================================================
% Generate shape of gradient waveform with StepResp
%=========================================================

function [PROJimp,TGSR,GSR,IMPipt,err] = TPI_SRIstandard_v1a(PROJimp,qT,G,IMPipt,err)

PROJimp.SRIdata = IMPipt(strcmp('SRI_Data',{IMPipt.labelstr})).runfuncoutput{1};
load(PROJimp.SRIdata);
