...
function [SCRPTipt,projdist,projdistrc,err] = pad2aRCOS_v2c(SCRPTipt,projdist,projdistrc)
...
% RCOS
%----------------------------------------------
ncones = projdistrc.ncones;
nprojcone = projdistrc.nprojcone;
phi = projdistrc.conephi;
n = 1;
IV = 0;
for i = 1:ncones  
