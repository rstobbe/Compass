...
function [OUTPUT,err] = Plot_ImpkSpace3D_v1b_Func(INPUT)
...
for n = start:stop
    ...
    figure(500); plot3(squeeze(Kmat(n,1:ind,1)),squeeze(Kmat(n,1:ind,2)),squeeze(Kmat(n,1:ind,3)),clr,'linewidth',1);
