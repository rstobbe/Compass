...
% - Gradient Step Response Accomodate (GSRA)
%=====================================================

function [PROJimp,G,GQKSA,WFM,IMPipt,err] = GWFM_GSRA_v1a(PROJdgn,PROJimp,T,KSA,WFM,IMPipt,err)
...
[PROJimp,G0,IMPipt,err] = func(PROJimp,qTscnr,G0,IMPipt,err);
for n = 1:length(err)
    if err(n).flag == 1
        return
    end
