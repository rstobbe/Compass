%=========================================================
% (v3a)
%   - Change in critical sampling to include gradient changes (from v2a)
%=========================================================

function [SCRPTipt,TSMPout,err] = TrajSamp_TPIstandard_v3a(SCRPTipt,TSMP)
...
PROJimp = TSMP.PROJimp;
GWFM = TSMP.GWFM;

%---------------------------------------------
% Dwell time for critical sampling
%---------------------------------------------                 
TSMPout.maxspherefreq = GWFM.Gmax*PROJdgn.fov/2*PROJimp.gamma;              % Spherical FoV
TSMPout.dwellcrit = 1000/(2*TSMPout.maxspherefreq);                         % in ms
TSMPout.dwelldesign = PROJdgn.iseg/(PROJdgn.rad*PROJdgn.p);                 % Spherical FoV

%---------------------------------------------
% Determine Filter BW (factor of 1000 Hz)
%---------------------------------------------
TSMPout.filtBW = 1000*ceil(TSMPout.maxspherefreq*TSMPout.relfiltbw0/1000);
TSMPout.relfiltbw = TSMPout.filtBW/TSMPout.maxspherefreq;
...
%---------------------------------------------
dwell0 = TSMPout.dwellcrit/oversamp;
...
TSMPout.trajosamp = TSMPout.dwelldesign/TSMPout.dwell;                  % how much oversampled from design
TSMPout.relsamp2filt = (1000*(1/TSMPout.dwell)/2)/TSMPout.filtBW;
TSMPout.samplingBW = 1000/TSMPout.dwell;
