%====================================================
% (v1e)
%   - same as 'ImpType_OutInDualEchoDefault_v1e'
%====================================================

function [SCRPTipt,IMPTYPE,err] = ImpType_YarnBallOutInDualEchoDefault_v1e(SCRPTipt,IMPTYPEipt)
...
load('SysRespFIR_Siemens_Fall2016_2','saveData');
