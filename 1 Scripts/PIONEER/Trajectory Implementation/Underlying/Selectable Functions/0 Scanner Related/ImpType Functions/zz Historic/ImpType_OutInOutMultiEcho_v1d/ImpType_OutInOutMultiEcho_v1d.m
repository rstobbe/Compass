%====================================================
% (v1d)
%   - add delay before 3rd echo
%====================================================

function [SCRPTipt,IMPTYPE,err] = ImpType_OutInOutMultiEcho_v1d(SCRPTipt,IMPTYPEipt)
...
IMPTYPE.echo3delay = str2double(IMPTYPEipt.('Echo3Delay'));
