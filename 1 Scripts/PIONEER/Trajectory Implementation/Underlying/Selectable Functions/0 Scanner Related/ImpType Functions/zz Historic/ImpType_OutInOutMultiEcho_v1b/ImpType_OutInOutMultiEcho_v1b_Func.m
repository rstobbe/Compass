...
function [IMPTYPE,err] = ImpType_OutInOutMultiEcho_v1b_Func(IMPTYPE,INPUT)
...
%         plot(Rad1,'k','linewidth',1);
    ...
    KmatDisplay(SampStart2:SampStart2+npro-1,:,2) = Kmat0(:,SampStart2:SampStart2+npro-1,:);
...
%         plot(Rad1,'k','linewidth',1);
    ...
    KmatDisplay(SampStart3:SampStart3+npro-1,:,3) = Kmat0(:,SampStart3:SampStart3+npro-1,:);
    KmatDisplay(1:SampStart3+npro-1,:,4) = Kmat0(:,1:SampStart3+npro-1,:);
    
    IMPTYPE.SampStart = [1 SampStart2 SampStart3];
