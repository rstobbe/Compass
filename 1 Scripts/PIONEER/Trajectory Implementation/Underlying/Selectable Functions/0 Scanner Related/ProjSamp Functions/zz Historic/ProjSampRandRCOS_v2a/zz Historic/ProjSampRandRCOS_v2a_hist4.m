...
minreldist = str2double(SCRPTipt(strcmp('MinRelDist',{SCRPTipt.labelstr})).entrystr);
...
if SCRPTGBL.testing == 1
    ...
    osampphi = sqrt(totalprojs/projdist.thnproj);
    osamptheta = sqrt(totalprojs/projdist.thnproj);
