...
function [PSMP,err] = ProjSamp_SpecifyFull_v1f_Func(PSMP,INPUT) 
...
if SPIN.PolSampUsed >= 0.95
    polreconosampfact = 1;
%elseif SPIN.PolSampUsed >= 0.90 && SPIN.PolSampUsed < 0.95
%    error;              % finish
else
...
error; %finish - projsampscnr must skip through discs as well
