...
function [IMETH,err] = ImpMeth_Cones_v1a_Func(IMETH,INPUT)

Status('busy','Implement Cones');
...
%---------------------------------------------
if not(strcmp(INPUT.DES.type,'Cones'))
    err.flag = 1;
    err.msg = '''ImpMeth_Cones'' is not valid for the trajectory design';
    return
end
...
GwfmPanel(3,:) = {'Cones',IMPTYPE.ncones,'Output'};
GwfmPanel(4,:) = {'OverProj',PROJdgn.projosamp,'Output'};
...
KsmpPanel(6,:) = {'ProjOverSamp',PROJdgn.projosamp,'Output'};
