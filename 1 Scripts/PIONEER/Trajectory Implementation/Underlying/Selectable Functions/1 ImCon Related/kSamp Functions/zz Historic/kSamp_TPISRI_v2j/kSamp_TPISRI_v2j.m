...
function [SCRPTipt,KSMPout,err] = kSamp_TPISRI_v2j(SCRPTipt,KSMP)
...
KSMPout.rRadStepFirst = mean(rRad(:,1));
...
%----------------------------------------------------
% Test Relative Sampling Maximum
%----------------------------------------------------
...
% Panel
%----------------------------------------------------
Panel(1,:) = {'rRadStepFirst',KSMPout.rRadStepFirst,'Output'};
Panel(2,:) = {'rRadStepMax',KSMPout.rRadStepMax,'Output'};
Panel(3,:) = {'meanrelkmax',KSMPout.meanrelkmax,'Output'};
Panel(4,:) = {'rSNR',KSMPout.rSNR,'Output'};
