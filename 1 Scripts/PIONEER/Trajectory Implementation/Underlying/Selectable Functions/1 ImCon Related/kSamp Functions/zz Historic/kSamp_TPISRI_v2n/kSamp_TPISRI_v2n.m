%=====================================================
% (v2n) 
%       - update for choice to save TSRI and GSRI
%       - use average gradient segment area for k-space recalc
%=====================================================

function [SCRPTipt,KSMP,err] = kSamp_TPISRI_v2n(SCRPTipt,KSMPipt)
