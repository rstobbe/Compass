...
function [PROJimp,samp,Kmat,Kend,IMP,IMPipt,err] = SRI_v2g(PROJdgn,PROJimp,G,IMP,IMPipt,err)
...
gVis = IMPipt(strcmp('GwfmSRI Vis',{IMPipt.labelstr})).entrystr;
if iscell(gVis)
    gVis = IMPipt(strcmp('GwfmSRI Vis',{IMPipt.labelstr})).entrystr{IMPipt(strcmp('GwfmSRI Vis',{IMPipt.labelstr})).entryvalue};
end
...
%----------------------------------------------------
if IMP.testing == 1
    phi = PROJdgn.TestInitProjVec.conephi;
