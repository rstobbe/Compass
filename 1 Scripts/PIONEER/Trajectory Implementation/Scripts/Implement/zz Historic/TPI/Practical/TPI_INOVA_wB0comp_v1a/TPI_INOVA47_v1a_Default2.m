...
function [default] = TPI_INOVA47_v1a_Default2(SCRPTPATHS)
...
if strcmp(filesep,'\')
    ...
    B0Comppath = [SCRPTPATHS.rootloc,'Trajectory Implementation\Underlying\Selectable Functions\1 ImCon Related\B0Comp Functions\'];
...
GWFMfunc = 'GWFM_GSRA_v1d';
TrajSampfunc = 'TrajSamp_TPIstandard_v3b';
ProjSampfunc = 'ProjSamp_Cones_v1d';
kSampfunc = 'kSamp_TPISRI_v2m';
B0Compfunc = 'B0Comp_MeasResp_v1a';
...
addpath([B0Comppath,B0Compfunc]);
Default = 'TPI_GSRAstandard';
System = 'Varian Inova';
SlvNo = '1000';
Orient = 'Axial';
...
m = m+1;
default{m,1}.entrytype = 'ScrptFunc';
default{m,1}.labelstr = 'B0Compfunc';
default{m,1}.entrystr = B0Compfunc;
default{m,1}.searchpath = B0Comppath;
default{m,1}.path = [B0Comppath,B0Compfunc];
