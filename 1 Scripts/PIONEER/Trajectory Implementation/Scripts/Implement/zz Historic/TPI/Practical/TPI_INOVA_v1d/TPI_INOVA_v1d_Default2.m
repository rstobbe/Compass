...
function [default] = TPI_INOVA_v1d_Default2(SCRPTPATHS)
...
QVecSlvfunc = 'QVecSlv_TPI_v2a';
GWFMfunc = 'GWFM_GSRA_v1c';
TrajSampfunc = 'TrajSamp_TPIstandard_v3a';
ProjSampfunc = 'ProjSamp_Cones_v1c';
kSampfunc = 'kSamp_TPISRI_v2l';
SysImpfunc = 'SysImp_InovaTPI_v1a';
