...
function [SCRPTipt,SCRPTGBL,err] = CATPI1_INOVA_v1gHipOrnt(SCRPTipt,SCRPTGBL)
...
PROJimp.orient = 'Coronal';
PROJimp.hippoangle = str2double(SCRPTGBL.CurrentTree.('HippoAngle'));
