%=========================================================
% (v1g)
%   - Change nucleus selection to a function (easy to update...)
%  
%=========================================================

function [SCRPTipt,SCRPTGBL,err] = TPI_INOVA_v1g(SCRPTipt,SCRPTGBL)
...
IMP.name = name{1};
SCRPTipt(strcmp('Imp_Name',{SCRPTipt.labelstr})).entrystr = IMP.name;
