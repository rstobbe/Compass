...
function [default] = TPI_Ideal_RCOS_v1a_Default2(SCRPTPATHS)
...
if strcmp(filesep,'\')
    ...
    TrajSamppath = [SCRPTPATHS.rootloc,'Trajectory Implementation\Underlying\Selectable Functions\0 Scanner Related\TrajSamp Functions\RCOS'];
...
Imp_Name = 'TPI_Ideal_RCOS';
Nucleus = '1H';
SlvNo = '1000';
Orient = 'Axial';
TrajSampfunc = 'TrajSamp_Ideal_v1a';
ProjSampfunc = 'ProjSampConesRCOS_v1a';
