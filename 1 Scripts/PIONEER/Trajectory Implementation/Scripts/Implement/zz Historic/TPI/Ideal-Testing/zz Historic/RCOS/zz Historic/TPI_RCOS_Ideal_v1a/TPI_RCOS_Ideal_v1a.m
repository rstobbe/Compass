...
function [SCRPTipt,SCRPTGBLout,err] = TPI_RCOS_Ideal_v1a(SCRPTipt,SCRPTGBL)
...
ImpStrct.IV = PROJimp.projdist0.IV;
[T0,KSA0] = TPI_GenProj_v2a(PROJdgn,ImpStrct);

%----------------------------------------------------
% Generate ReCon Projections
%----------------------------------------------------
if SCRPTGBL.testing ~= 1
    ImpStrct.slvno = PROJimp.slvno;
    ImpStrct.IV = PROJimp.projdistrc.IV;
    [Trc,KSArc] = TPI_GenProj_v2a(PROJdgn,ImpStrct);
    T = T0;
    KSA = [KSA0;KSArc];
else
    T = T0;
...
if SCRPTGBL.testing == 1
    ...
    phi = PROJimp.projdist0.conephi;
    projindx = PROJimp.projdist0.projindx;
    for n = 1:length(phi)
