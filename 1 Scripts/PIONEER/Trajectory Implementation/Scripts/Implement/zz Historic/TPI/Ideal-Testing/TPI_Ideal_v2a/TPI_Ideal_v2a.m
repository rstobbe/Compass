...
[T,KSA] = TPI_GenProj_v3a(PROJdgn,ImpStrct);
...
for n = 1:L
    Kmat(n,:,1) = interp1(impPROJdgn.tro*T/projlen,KSA(n,:,1)*impPROJdgn.kmax,samp,'linear','extrap');
    Kmat(n,:,2) = interp1(impPROJdgn.tro*T/projlen,KSA(n,:,2)*impPROJdgn.kmax,samp,'linear','extrap');
    Kmat(n,:,3) = interp1(impPROJdgn.tro*T/projlen,KSA(n,:,3)*impPROJdgn.kmax,samp,'linear','extrap');
end
if isnan(Kmat)
    error('NaN Problem');
end
