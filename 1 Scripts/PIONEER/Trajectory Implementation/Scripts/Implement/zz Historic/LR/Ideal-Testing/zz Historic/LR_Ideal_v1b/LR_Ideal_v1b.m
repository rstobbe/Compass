...
function [SCRPTipt,SCRPTGBLout,err] = LR_Ideal_v1b(SCRPTipt,SCRPTGBL)
...
for n = 1:L
    Kmat(n,:,1) = interp1(T(n,:),KSA(n,:,1)*PROJdgn.kmax,samp);
    Kmat(n,:,2) = interp1(T(n,:),KSA(n,:,2)*PROJdgn.kmax,samp);
    Kmat(n,:,3) = interp1(T(n,:),KSA(n,:,3)*PROJdgn.kmax,samp);
end
