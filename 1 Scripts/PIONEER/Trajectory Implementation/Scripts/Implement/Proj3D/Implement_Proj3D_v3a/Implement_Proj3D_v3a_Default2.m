...
function [default] = Implement_Proj3D_v3a_Default2(SCRPTPATHS)

if strcmp(filesep,'\')
    Testpath = [SCRPTPATHS.pioneerloc,'Trajectory Implementation\Underlying\Selectable Functions\0 Scanner Related\Testing Functions\YarnBall\'];
    ...
    ImpMethpath = [SCRPTPATHS.pioneerloc,'Trajectory Implementation\Underlying\Selectable Functions\0 Scanner Related\ImpMeth Functions\ImpMeth_YarnBall_v1a\'];
elseif strcmp(filesep,'/')
end
Nucfunc = 'H1_v1a';
Testfunc = 'TrajTest_YarnBallTestFull_v1c';
