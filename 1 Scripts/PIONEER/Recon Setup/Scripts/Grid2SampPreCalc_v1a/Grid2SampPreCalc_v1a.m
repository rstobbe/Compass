...
%     
%==================================================
function [SCRPTipt,SCRPTGBL,err] = Grid2SampPreCalc_v1a(SCRPTipt,SCRPTGBL)
...
RDAT.ImpFile = SCRPTGBL.CurrentTree.('Imp_File').EntryStr;
RDAT.KernFile = SCRPTGBL.CurrentTree.('Kern_File').EntryStr;
