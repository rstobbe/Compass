...
function [meov,ANLZ] = MEOVatIrsMeNeiSnrArr_v1a_Reg(V,ANLZ,INPUT)
...
% Find ROI
%--------------------------------------    
Status2('busy','Find VOI at Minimum Edge',2);
...
[ROI,err] = MaxVoiForAverageIrsMinEdge_v1a(ROI,INPUT);
clear INPUT;
if err.flag
    error
end
