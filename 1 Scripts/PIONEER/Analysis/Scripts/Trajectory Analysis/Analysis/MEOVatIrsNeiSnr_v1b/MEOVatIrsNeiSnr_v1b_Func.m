...
function [ANLZ,err] = MEOVatIrsNeiSnr_v1b_Func(ANLZ,INPUT)
...
%TF = INPUT.TF;
%PSD = INPUT.PSD;
vox = INPUT.TF.PROJdgn.vox^3 / INPUT.TF.PROJdgn.elip;
...
options = optimset( 'Algorithm','trust-region-reflective',...
                    ...
                    'TolX',1e-4);
V0 = 30;
func = @(V)MEOVatIrsNeiSnr_v1b_Reg(V,ANLZ,INPUT);
lb = 1;
ub = 200;
...
% Test
%---------------------------------------------
[out,ANLZ] = MEOVatIrsNeiSnr_v1b_Reg(V,ANLZ,INPUT);
...
Panel(11,:) = {'',[],'Output'};
Panel(12,:) = {'TF',INPUT.TF.name,'Output'};
