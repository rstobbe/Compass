...
function [SCRPTipt,SCRPTGBL,err] = OB_IRS_atVOI_relationship_v1a(SCRPTipt,SCRPTGBL)
...
ANLZ.roifunc = SCRPTGBL.CurrentTree.('ROIfunc').Func; 
...
ROIipt = SCRPTGBL.CurrentTree.('ROIfunc');
if isfield(SCRPTGBL,('ROIfunc_Data'))
    ROIipt.Objectfunc_Data = SCRPTGBL.Objectfunc_Data;
end
