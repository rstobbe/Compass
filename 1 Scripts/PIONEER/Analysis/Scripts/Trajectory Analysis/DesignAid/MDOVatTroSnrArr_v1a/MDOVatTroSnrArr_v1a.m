...
function [SCRPTipt,SCRPTGBL,err] = MEOVatTroSnrArr_v1a(SCRPTipt,SCRPTGBL)
...
ANLZ.relinc = str2double(SCRPTGBL.CurrentTree.('RelInc'))/100;
ANLZ.start = str2double(SCRPTGBL.CurrentTree.('Start'));
