...
function [SCRPTipt,SCRPTGBL,err] = PSFA_AnlzFromFile_v1a(SCRPTipt,SCRPTGBL)

Status('busy','PSFA Analysis Within a Fixed Object');
Status2('done','',2);
Status2('done','',3);
...
ANLZ.calcfunc = SCRPTGBL.CurrentTree.('Calcfunc').Func; 
...
% Name
%--------------------------------------------
name = ['ANLZ_AccFixOb_',PSF.name(5:end)];
