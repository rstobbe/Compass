...
function [IMP,err] = PerfSampMatchDes2D_v1a_Func(INPUT)
...
% Test
%----------------------------------------------
r = sqrt(kSampArr(:,1).^2 + kSampArr(:,2).^2);
figure(1);
...
Kmat = zeros(1,length(kSampArr),2);
Kmat(1,:,:) = kSampArr;
IMP.Kmat = Kmat;
IMP.PROJimp = PROJimp;
IMP.impPROJdgn = PROJdgn;
IMP.impPROJdgn.nproj = 1;
