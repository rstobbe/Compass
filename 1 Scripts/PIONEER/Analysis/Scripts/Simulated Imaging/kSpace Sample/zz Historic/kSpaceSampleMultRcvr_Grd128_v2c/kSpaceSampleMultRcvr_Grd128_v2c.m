...
function [SCRPTipt,SCRPTGBL,err] = kSpaceSampleMultRcvr_Grd128_v2c(SCRPTipt,SCRPTGBL)
...
SAMP.RcvProfFunc = SCRPTGBL.CurrentTree.('RcvProffunc').Func;
...
RPROFipt = SCRPTGBL.CurrentTree.('RcvProffunc');
if isfield(SCRPTGBL,('RcvProffunc_Data'))
    RPROFipt.RcvProffunc_Data = SCRPTGBL.RcvProffunc_Data;
end
...
% Get Object Function Info
%------------------------------------------
func = str2func(SAMP.RcvProfFunc);           
[SCRPTipt,RPROF,err] = func(SCRPTipt,RPROFipt);
if err.flag
    return
end

%------------------------------------------
% Get Grid Function Info
%------------------------------------------
