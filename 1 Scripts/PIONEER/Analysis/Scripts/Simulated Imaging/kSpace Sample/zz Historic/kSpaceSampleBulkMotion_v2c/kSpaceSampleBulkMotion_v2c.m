...
function [SCRPTipt,SCRPTGBL,err] = kSpaceSampleBulkMotion_v2c(SCRPTipt,SCRPTGBL)
...
SAMP.mottype = SCRPTGBL.CurrentTree.MotionType;
SAMP.MotionFunc = SCRPTGBL.CurrentTree.Motionfunc.Func;
...
MOTipt = SCRPTGBL.CurrentTree.('Motionfunc');
if isfield(SCRPTGBL,('Motionfunc_Data'))
    MOTipt.Motionfunc_Data = SCRPTGBL.Motionfunc_Data;
end
...
%------------------------------------------
% Get Motion Function Info
%------------------------------------------
func = str2func(SAMP.MotionFunc);           
[SCRPTipt,MOT,err] = func(SCRPTipt,MOTipt);
if err.flag
    return
end
