...
function [default] = kSpaceSampleBulkMotion_v2c_Default2(SCRPTPATHS)
...
default{m,1}.options = {'ShiftHalf','FullShift','Random'};

m = m+1;
default{m,1}.entrytype = 'ScrptFunc';
default{m,1}.labelstr = 'Motionfunc';
