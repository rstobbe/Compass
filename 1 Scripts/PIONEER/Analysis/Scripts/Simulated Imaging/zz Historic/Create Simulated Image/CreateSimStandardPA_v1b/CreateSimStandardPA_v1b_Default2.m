...
function [default] = CreateSimStandardPA_v1b_Default2(SCRPTPATHS)

if strcmp(filesep,'\')
    imagepath = [SCRPTPATHS.voyagerloc,'Image Creation\Underlying\Selectable Functions\Image Creation Via Gridding\'];    
