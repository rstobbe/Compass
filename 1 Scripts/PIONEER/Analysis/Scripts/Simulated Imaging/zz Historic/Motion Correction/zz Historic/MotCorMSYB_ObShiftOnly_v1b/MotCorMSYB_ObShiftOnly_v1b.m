...
function [SCRPTipt,SCRPTGBL,err] = MotCorMSYB_ObShiftOnly_v1b(SCRPTipt,SCRPTGBL)
...
MOTCOR.obshftcorfunc = SCRPTGBL.CurrentTree.('ObShftCorfunc').Func;
...
%---------------------------------------------
OBSHFTipt = SCRPTGBL.CurrentTree.('ObShftCorfunc');
if isfield(SCRPTGBL,('ObShftCorfunc_Data'))
    OBSHFTipt.ObShftCorfunc_Data = SCRPTGBL.ObShftCorfunc_Data;
end

%------------------------------------------
% Get Object Shift Correction Function Info
%------------------------------------------
func = str2func(MOTCOR.obshftcorfunc);           
[SCRPTipt,OBSHFT,err] = func(SCRPTipt,OBSHFTipt);
if err.flag
    return
end
