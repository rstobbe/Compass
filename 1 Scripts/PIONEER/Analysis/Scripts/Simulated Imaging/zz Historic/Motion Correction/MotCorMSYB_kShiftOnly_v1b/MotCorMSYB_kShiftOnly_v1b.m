...
function [SCRPTipt,SCRPTGBL,err] = MotCorMSYB_kShiftOnly_v1b(SCRPTipt,SCRPTGBL)

Status('busy','Correct for k-Space Shift (MSYB)');
Status2('done','',2);
Status2('done','',3);
...
MOTCOR.kshftcorfunc = SCRPTGBL.CurrentTree.('kShiftCorfunc').Func;
...
%---------------------------------------------
KSHFTCORipt = SCRPTGBL.CurrentTree.('kShiftCorfunc');
if isfield(SCRPTGBL,('RotCorfunc_Data'))
    KSHFTCORipt.kShiftCorfunc_Data = SCRPTGBL.kShiftCorfunc_Data;
end
