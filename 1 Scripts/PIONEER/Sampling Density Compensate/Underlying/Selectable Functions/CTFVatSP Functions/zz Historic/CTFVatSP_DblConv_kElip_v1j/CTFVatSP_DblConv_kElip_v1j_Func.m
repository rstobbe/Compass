...
function [CTFV,err] = CTFVatSP_DblConv_kElip_v1j_Func(CTFV,INPUT)
...
elseif strcmp(SDCS.Device,'CUDA')
    CUDAdevice = 1;
    if strcmp(SDCS.Precision,'Double')
        CTFV.S2GConvfunc = 'mS2GCUDADoubleR_v4f';
        CTFV.G2SConvfunc = 'mG2SCUDADoubleR_v4f';
    elseif strcmp(SDCS.Precision,'Single')
        CTFV.S2GConvfunc = 'mS2GCUDASingleR_v4f';
        CTFV.G2SConvfunc = 'mG2SCUDASingleR_v4f';
    end
end
