...
function [IT,err] = Iterate_DblConv_v1n_Func(IT,INPUT)
...
if strcmp(SDCS.precision,'Double')
    IT.S2GConvfunc = 'mS2GCUDADoubleR_v5b';
    IT.G2SConvfunc = 'mG2SCUDADoubleR_v5b';
elseif strcmp(SDCS.precision,'Single')
    IT.S2GConvfunc = 'mS2GCUDASingleR_v5b';
    IT.G2SConvfunc = 'mG2SCUDASingleR_v5b';
end
...
for j = iterations + 1:500   
    ...
    W = W/(RvsKern.convscaleval*SDCS.SubSamp^3);                        % only this one direction need SubSamp correction
