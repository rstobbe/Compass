%================================================================================
% (v1b)
%    - max possible subsamp = input.  
%================================================================================

function [CTF,SCRPTipt,err] = CTF_Sphere_v1b(PROJdgn,PROJimp,TF,KRNprms,CTF,SDCS,SCRPTipt,err)
...
if isfield(PROJdgn,'elip')
    if PROJdgn.elip ~= 1;                   
        ...
        err(errn).flag = 1;
        err(errn).msg = 'Elip Not Supported with CTF_Sphere_v1b';
        return
    end
end
