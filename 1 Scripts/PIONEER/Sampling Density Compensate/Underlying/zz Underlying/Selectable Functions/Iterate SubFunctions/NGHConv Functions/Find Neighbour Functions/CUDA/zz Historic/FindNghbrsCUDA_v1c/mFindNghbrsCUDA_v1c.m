...
function [NGH,error,errorflag] = mFindNghbrsCUDA_v1c(Kmat,W,AIDrp) 
...
memtst = 0;
[Kxinds,Kxindlens,test,CUDA,error0] = FindXNghbrsCUDA_v1c(single(Kx),int32(Radinds),int32(npro),int32(nproj),...
...
Dpts = (1:dpts);
memtst = 1;
[~,~,test,CUDA,error0] = FindXNghbrsCUDA_v1c(single(Kx),int32(Radinds),int32(npro),int32(nproj),...
                                                     int32(maxkxindlen),single(W),int32(Dpts),int32(memtst));
...
memtst = 0;        
[Kyinds,Kyindlens,~,error0] = FindYZNghbrsCUDA_v1c(single(Ky),int32(Kxinds),int32(Kxindlens),int32(maxkxindlen),...
...
Dpts = (1:dpts);
memtst = 1;
[~,~,test,error0] = FindYZNghbrsCUDA_v1c(single(Ky),int32(Kxinds),int32(Kxindlens),int32(maxkxindlen),...
                                                     int32(npro),int32(nproj),int32(maxkyindlen),single(W),int32(Dpts),int32(memtst)); 
if (strcmp(error0,'out of memory'))
    error = ['Cuda: ',error0]; errorflag = 1; return;
end
...
memtst = 0;        
[Kzinds,Kzindlens,~,error0] = FindYZNghbrsCUDA_v1c(single(Kz),int32(Kyinds),int32(Kyindlens),int32(maxkyindlen),...
...
Dpts = (1:dpts);
memtst = 1;
[~,~,test,error0] = FindYZNghbrsCUDA_v1c(single(Kz),int32(Kyinds),int32(Kyindlens),int32(maxkyindlen),...
                                                     int32(npro),int32(nproj),int32(maxkzindlen),single(W),int32(Dpts),int32(memtst)); 
if (strcmp(error0,'out of memory'))
    error = ['Cuda: ',error0]; errorflag = 1; return;
end
...
for n = 1:N
    ...
    [Kyinds,Kyindlens,test,error0] = FindYZNghbrsCUDA_v1c(single(Ky),int32(Kxinds),int32(Kxindlens),int32(maxkxindlen),...
                                                         int32(npro),int32(nproj),int32(maxkyindlen),single(W),int32(Dpts),int32(memtst));
    if not(strcmp(error0,'no error'))
        error = ['Cuda: ',error0]; errorflag = 1; return;
    end
    ...
    [Kzinds,Kzindlens,test,error0] = FindYZNghbrsCUDA_v1c(single(Kz),int32(Kyinds),int32(Kyindlens),int32(maxkyindlen),...
                                                         int32(npro),int32(nproj),int32(maxkzindlen),single(W),int32(Dpts),int32(memtst)); 
    if not(strcmp(error0,'no error'))
        error = ['Cuda: ',error0]; errorflag = 1; return;
    end
