function cFindXNghbrsCUDA_v1b

%Stick with VS2005 for mex -setup until...

!"%VS80COMNTOOLS%vsvars32.bat" & nvcc FindXNghbrsCUDA_v1c.cu -c -arch=sm_21 -m64 -Xptxas -v 
...
mex(['-L',n],'-lcudart','FindXNghbrsCUDA_v1c.obj','FindXNghbrsCUDA_v1b.cpp');
