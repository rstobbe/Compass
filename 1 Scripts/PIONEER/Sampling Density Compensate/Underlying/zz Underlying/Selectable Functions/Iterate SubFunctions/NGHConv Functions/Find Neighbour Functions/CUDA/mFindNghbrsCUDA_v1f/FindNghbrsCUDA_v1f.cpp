...
slmults = (float*)mxGetData(prhs[13]);
...
// Find Neighbours
//-------------------------------------------
FindNgh(Kx,Ky,Kz,Radinds,NGH,NGHlens,npro,nproj,W,MaxXNghbrs,MaxYNghbrs,MaxZNghbrs,Dpts,Dptlen0,ErrString,TstIn,TstOut,slmults[0],slmults[1],slmults[2]);
