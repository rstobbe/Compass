function cQueryReset_v1e

%Stick with VS2005 for mex -setup until...

!"%VS80COMNTOOLS%vsvars32.bat" & nvcc QueryReset_v1e.cu -c -arch=sm_21 -m64 -Xptxas -v 
...
mex(['-L',n],'-lcudart','QueryReset_v1e.obj','QueryReset_v1e.cpp');
