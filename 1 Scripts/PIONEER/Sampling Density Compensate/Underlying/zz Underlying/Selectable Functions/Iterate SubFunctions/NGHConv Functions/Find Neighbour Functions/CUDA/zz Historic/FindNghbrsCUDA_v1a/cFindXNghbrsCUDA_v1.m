function cFindXNghbrsCUDA_v1

%Stick with VS2005 for mex -setup until but 2010...

!"%VS80COMNTOOLS%vsvars32.bat" & nvcc FindXNghbrsCUDA_v1.cu -c -arch=sm_11 -m64 -Xptxas -v 
...
mex(['-L',n],'-lcudart','FindXNghbrsCUDA_v1.obj','FindXNghbrsCUDA_v1.cpp');
