function cFindYZNghbrsCUDA_v1b

%Stick with VS2005 for mex -setup until but 2010...

!"%VS80COMNTOOLS%vsvars32.bat" & nvcc FindYZNghbrsCUDA_v1b.cu -c -arch=sm_21 -m64 -Xptxas -v 
...
mex(['-L',n],'-lcudart','FindYZNghbrsCUDA_v1b.obj','FindYZNghbrsCUDA_v1b.cpp');
