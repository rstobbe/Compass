function cFindNghbrsCUDA_v1d

%Stick with VS2005 for mex -setup until...

!"%VS80COMNTOOLS%vsvars32.bat" & nvcc FindNghbrsCUDA_v1d.cu -c -arch=sm_21 -m64 -Xptxas -v 
!"%VS80COMNTOOLS%vsvars32.bat" & nvcc AllocatePermMem_v1d.cu -c -arch=sm_21 -m64 -Xptxas -v 
!"%VS80COMNTOOLS%vsvars32.bat" & nvcc QueryReset_v1d.cu -c -arch=sm_21 -m64 -Xptxas -v 
...
mex(['-L',n],'-lcudart',...
    'FindNghbrsCUDA_v1d.obj',...
    'AllocatePermMem_v1d.obj',...
    'QueryReset_v1d.obj',...
    'FindNghbrsCUDA_v1d.cpp');
