function cFindNghbrsCUDA_v1f

%Stick with VS2005 for mex -setup until...

!"%VS80COMNTOOLS%vsvars32.bat" & nvcc FindNghbrsCUDA_v1f.cu -c -arch=sm_21 -m64 -Xptxas -v 
...
mex(['-L',n],'-lcudart','FindNghbrsCUDA_v1f.obj','FindNghbrsCUDA_v1f.cpp');
