...
if strcmp(ANLZ.visuals,'On')
    ...
    title('Mean SDC Values at Sampling Point Locations'); xlabel('sampling point number');  

    subplot(2,2,2); hold on;
    plot(xaxmean,DOVarr,'k');
    plot(xaxmean,Warr,'r');
    title('Mean Output Values at Sampling Point Locations'); xlabel('sampling point number');  
