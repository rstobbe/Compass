...
function [default] = SDC_DblConv_v1h_Default2(SCRPTPATHS)
...
CTFfunc = 'CTFVatSP_DblConv_kSphere_v1l';
...
default{m,1}.labelstr = 'Device';
default{m,1}.entrystr = 'Mex';
default{m,1}.options = {'Mex','CUDA'};

m = m+1;
default{m,1}.entrytype = 'Choose';
default{m,1}.labelstr = 'Precision';
default{m,1}.entrystr = 'Single';
default{m,1}.options = {'Double','Single'};
