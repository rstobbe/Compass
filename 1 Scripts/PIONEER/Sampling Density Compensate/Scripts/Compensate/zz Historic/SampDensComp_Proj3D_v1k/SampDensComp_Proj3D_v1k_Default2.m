...
function [default] = SampDensComp_Proj3D_v1k_Default2(SCRPTPATHS)
...
OPTfunc = 'Options_Standard_v1a';
TFfunc = 'TF_KaiserPlank_v1b';
CTFfunc = 'CTFVatSP_DblConv_kSphere_v1o';
IEfunc = 'InitialEst_SDestDesSphere_v1g';
ITfunc = 'Iterate_DblConv_v1m';
