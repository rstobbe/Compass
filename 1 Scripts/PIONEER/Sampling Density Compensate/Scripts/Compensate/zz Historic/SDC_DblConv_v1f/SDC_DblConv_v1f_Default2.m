...
function [default] = SDC_DblConv_v1f_Default2(SCRPTPATHS)
...
TFfunc = 'TF_MatchSD_v1c';
CTFfunc = 'CTFVatSP_DblConv_kSphere_v1e';
IEfunc = 'InitialEst_Radial_v1b';
ITfunc = 'Iterate_DblConv_v1d';
