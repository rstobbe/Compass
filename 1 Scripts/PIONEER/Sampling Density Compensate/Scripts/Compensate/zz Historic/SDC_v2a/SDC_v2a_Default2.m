...
function [default] = SDC_v2a_Default2(SCRPTPATHS)
...
if strcmp(filesep,'\')
    ...
    CTFVatSPPath = [SCRPTPATHS.rootloc,'Sampling Density Compensate\Underlying\Selectable Functions\CTFVatSP Functions\'];
...
addpath(genpath(CTFVatSPPath));
addpath(genpath(ITPath));

SDC_Name = 'TPI_sphere_largevolume';
IEfunc = 'InitialEst_Radial_v1a';
subsamp = '2.5';
Kernfunc = 'Kern_FiltSinc_v2a';
TFfunc = 'TF_MatchSD_v1a';
CTFVatSPfunc = 'CTFVatSP_Sphere_v1a';
ITfunc = 'Iterate_GridBased_v1a';
...
default{m,1}.entrystr = CTFVatSPfunc;
default{m,1}.searchpath = CTFVatSPPath;
