%===========================================================================================
% (v1e)
%     - update for global handling
%===========================================================================================

function [SCRPTipt,SCRPTGBL,err] = SDC_DblConv_v1e(SCRPTipt,SCRPTGBL)
...
TFO = SCRPTGBL.CurrentTree.('TFfunc');
if isfield(SCRPTGBL,('TFfunc_Data'))
    TFO.SysImpfunc_Data = SCRPTGBL.TFfunc_Data;
end
...
[SCRPTipt,TFO,err] = func(SCRPTipt,TFO);
if err.flag
    return
end
