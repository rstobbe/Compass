...
function [default] = Anlz_RFwfmV_v1a_Default2(SCRPTPATHS)

if strcmp(filesep,'\')
    blochpath = [SCRPTPATHS.newhorizonsloc,'\Bloch Simulation\Underlying\Selectable Functions\Bloch Equations\'];
