...
function [filt,SCRPTipt] = Grad_LPF_v1a(Eddy,Params,SCRPTipt)

FTVis = SCRPTipt(strcmp('Grad_FT Vis',{SCRPTipt.labelstr})).entrystr;
if iscell(FTVis)
    FTVis = SCRPTipt(strcmp('Grad_FT Vis',{SCRPTipt.labelstr})).entrystr{SCRPTipt(strcmp('Grad_FT Vis',{SCRPTipt.labelstr})).entryvalue};
end
cutoff = str2double(SCRPTipt(strcmp('Grad_cutoff (Hz)',{SCRPTipt.labelstr})).entrystr)/1000;
