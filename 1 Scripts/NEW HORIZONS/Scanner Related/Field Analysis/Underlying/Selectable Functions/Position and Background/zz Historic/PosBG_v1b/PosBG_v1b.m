...
function [SCRPTipt,Output,err] = PosBG_v1b(SCRPTipt,SCRPTGBL,Input)
...
for w = 1:2
    ...
    %-------------------------------------
    ExpDisp = [];
    [PosLoc1,PosLoc2,expT,Params,ExpDisp,errorflag,error] = Load_2LocExperiment_v2(SCRPTGBL.File_PosLoc1.FIDLoc,SCRPTGBL.File_PosLoc2.FIDLoc,'PosLoc',Sys,'',ExpDisp);
    if errorflag == 1
        err.flag = 1;
        err.msg = error;
        return
    ...
    %-------------------------------------
    [BG1,BG2,expT,Params,ExpDisp,errorflag,error] = Load_2LocExperiment_v2(SCRPTGBL.File_NoGrad1.FIDLoc,SCRPTGBL.File_NoGrad2.FIDLoc,'BackGrad',Sys,'',ExpDisp);
    if errorflag == 1
        err.flag = 1;
        err.msg = error;
        return
