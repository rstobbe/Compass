...
function [MOD,err] = FirSysModelSiemens_BP30301501_v1b_Func(MOD,INPUT)
...
Time = (0:dwell:regend);
GradField = (interp1(Time0+delaygradient/1000,GradField0.',Time,'linear',0)).';
...
Panel(5,:) = {'Delay Gradient when Implementing (ms)',delaygradient,'Output'};
Panel(6,:) = {'Resultant Effective Trajectory Delay (ms)',efftrajdel,'Output'};
...
MOD.delaygradient = delaygradient;
MOD.regressiondelay = delaygradient; 
