...
function [SCRPTipt,FEVOL,err] = FieldEvoLoadBasicVarian_v1a(SCRPTipt,FEVOLipt)
...
FEVOL.File_NoGrad1 = FEVOLipt.([CallingLabel,'_Data']).('File_NoGrad1_Data').path;
FEVOL.File_NoGrad2 = FEVOLipt.([CallingLabel,'_Data']).('File_NoGrad2_Data').path;
FEVOL.File_PosLoc1 = FEVOLipt.([CallingLabel,'_Data']).('File_PosLoc1_Data').path;
FEVOL.File_PosLoc2 = FEVOLipt.([CallingLabel,'_Data']).('File_PosLoc2_Data').path;
