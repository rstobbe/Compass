...
function [FEVOL,err] = FieldEvoLoadShortEccMRS_v1a_Func(FEVOL,INPUT)
...
[TF_Fid1,TF_Fid2,TF_Params,TF_ExpDisp,err] = Load_2LocExperiment_v4b(FEVOL.File_Grad1,FEVOL.File_Grad2,'SingleRFPostGrad_v1a',Sys);
if err.flag
    return
end
