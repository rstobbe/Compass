...
function [Tpars,FID,ParamsDisp,StudyDisp,err] = LoadVarian_MultiRFPostGrad_v1a(path)
...
Tpars.exprep = str2double(Parse_Params(Text,'exprep'));
...
if isnan(Tpars.nacqs)
    err.flag = 1;
    err.msg = 'Only single RF pulse following gradient';
    return
end
...
for n = 1:length(ind)-1
    ...
    Tpars.initdels(n,:) = (initdel(n):Tpars.tr:Tpars.tr*Tpars.nacqs);
