%==================================================
% (v1d)
%       - add selection to measure rise or fall
%       - timing / normalization change
%==================================================

function [SCRPTipt,SCRPTGBL,err] = ExportGradStepResp_v1d(SCRPTipt,SCRPTGBL)
...
SR.type = SCRPTGBL.CurrentTree.('Type');
