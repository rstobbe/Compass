...
function [default] = ModelFull_GradSysResponse_v1a_Default2(SCRPTPATHS)
...
Modelfunc = 'FirSysModelSiemens_BP30301501_v1b';
...
default{m,1}.labelstr = 'FieldEvoX_File';
default{m,1}.entrystr = '';
...
m = m+1;
default{m,1}.entrytype = 'RunExtFunc';
default{m,1}.labelstr = 'FieldEvoY_File';
default{m,1}.entrystr = '';
default{m,1}.buttonname = 'Select';
default{m,1}.runfunc1 = 'LoadScriptFileCur';
default{m,1}.(default{m,1}.runfunc1).curloc = SCRPTPATHS.outloc;
...
m = m+1;
default{m,1}.entrytype = 'RunExtFunc';
default{m,1}.labelstr = 'FieldEvoZ_File';
default{m,1}.entrystr = '';
default{m,1}.buttonname = 'Select';
default{m,1}.runfunc1 = 'LoadScriptFileCur';
default{m,1}.(default{m,1}.runfunc1).curloc = SCRPTPATHS.outloc;
