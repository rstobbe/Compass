...
function [default] = PowerProfileAnlz_v1a_Default2(SCRPTPATHS)

if strcmp(filesep,'\')
    fidanlzpath = [SCRPTPATHS.newhorizonsloc,'Scanner Related\Field Analysis\Underlying\Selectable Functions\Probe Power Calibration\'];
...
fidanlzfunc = 'ProbeProfileTest_v1a';
...
default{m,1}.scrpttype = 'PowerTest';
default{m,1}.labelstr = 'PowerTest';
default{m,1}.entrystr = '';
