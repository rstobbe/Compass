%====================================================
% (v1b)
%    - visuals and regression moved out...
%====================================================

function [SCRPTipt,SCRPTGBL,err] = PostGradEddySingle_v1b(SCRPTipt,SCRPTGBL)
...
for n = 1:nexp 
    ...
    TF_B0_Joined(n,start:start+ind2-ind1) = TF_B01(n,ind1:ind2)*1000;
    TF_Grad_Joined(n,start:start+ind2-ind1) = TF_Grad(n,ind1:ind2)*1000;
end
...
SCRPTGBL.TF.Data.TF_Grad_Ave = TF_Grad_Ave;
SCRPTGBL.TF.Data.TF_B0_Ave = TF_B0_Ave;
