...
function [SCRPTipt,SCRPTGBL,err] = PreGradEddy_v1a(SCRPTipt,SCRPTGBL)
...
if(strcmp(GTVis,'Full') || strcmp(GTVis,'Partial'))
    Ghand = figure(320); hold on; plot([0 max(expT)],[meanBGGrad meanBGGrad],'k:'); plot(expT,GTrans,Clr);     
    ...
    B0hand = figure(321); hold on; plot([0 max(expT)],[meanBGB0*1000 meanBGB0*1000],'k:'); plot(expT,B0Trans1*1000,Clr); 
