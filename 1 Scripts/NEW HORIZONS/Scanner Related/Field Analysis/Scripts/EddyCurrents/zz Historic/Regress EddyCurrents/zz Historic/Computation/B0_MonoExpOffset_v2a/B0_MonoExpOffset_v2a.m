...
function [SCRPTipt,SCRPTGBL,err] = B0_MonoExpOffset_v2a(SCRPTipt,SCRPTGBL)
...
offset = str2double(SCRPTipt(strcmp('Offset (uT)',{SCRPTipt.labelstr})).entrystr);
...
[SCRPTipt] = AddToPanelOutput(SCRPTipt,'B0_CompVal (V%)','0output',-B0beta(1)*1000/(B0cal*gval),'0numout');
...
plot(time,B0eddy*1000,'k-');
plot(B0fit.interptime,B0fit.interpvals*1000+offset,[clr,'-'],'linewidth',2);
