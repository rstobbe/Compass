...
function [default] = MonoExpOffset_v1a_Default2(SCRPTPATHS)
...
default{m,1}.labelstr = 'Source';
default{m,1}.entrystr = 'QAlong';
default{m,1}.options = {'Standard','QAlong','QAshort','RFPreGrad'};
...
m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'Offset (au)';
default{m,1}.entrystr = '0';
