...
function [SCRPTipt,SCRPTGBL,err] = ShortEddyDecayFitting_v1a(SCRPTipt,SCRPTGBL)
...
RGRS.regressfunc = SCRPTGBL.CurrentTree.('Regressfunc').Func;
...
%---------------------------------------------
ECMipt = SCRPTGBL.CurrentTree.('Regressfunc');
if isfield(SCRPTGBL,('Regressfunc_Data'))
    ECMipt.Regressfunc_Data = SCRPTGBL.Regressfunc_Data;
end

%------------------------------------------
% Model Function Info
%------------------------------------------
func = str2func(RGRS.regressfunc);           
