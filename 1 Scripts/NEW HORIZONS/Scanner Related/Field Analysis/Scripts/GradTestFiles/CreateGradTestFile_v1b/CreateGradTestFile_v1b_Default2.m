...
function [default] = CreateGradTestFile_v1b_Default2(SCRPTPATHS)

if strcmp(filesep,'\')
    syswrtpath = [SCRPTPATHS.pioneerloc,'System Write\Underlying\Selectable Functions\WrtSys Functions\'];
...
syswrt = 'WrtSys_SiemensGeneric_v1c';
