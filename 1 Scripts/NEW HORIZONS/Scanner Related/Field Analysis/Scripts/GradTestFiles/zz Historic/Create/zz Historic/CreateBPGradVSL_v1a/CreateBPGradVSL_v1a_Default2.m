...
function [default] = CreateBPGradVSL_v1a_Default2(SCRPTPATHS)
...
if strcmp(filesep,'\')
    ...
    wrmatpath = [SCRPTPATHS.scrptshareloc,'\0 General\Selectable Functions\File Related\WriteMatFile_v1a'];
