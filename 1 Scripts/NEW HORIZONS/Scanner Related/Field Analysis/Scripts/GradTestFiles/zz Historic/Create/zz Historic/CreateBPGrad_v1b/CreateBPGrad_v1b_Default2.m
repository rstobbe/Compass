...
function [default] = CreateBPGrad_v1b_Default2(SCRPTPATHS)

if strcmp(filesep,'\')
    wrgradpath = [SCRPTPATHS.scrptshareloc,'1 MRI Systems\Selectable Functions\'];
    wrparmpath = [SCRPTPATHS.scrptshareloc,'1 MRI Systems\Selectable Functions\'];
    wrmatpath = [SCRPTPATHS.scrptshareloc,'\0 General\Selectable Functions\File Related\'];
elseif strcmp(filesep,'/')
end
wrmat = 'WriteMatFile_v1a';
...
default{m,1}.labelstr = 'WrtMatFnc';
default{m,1}.entrystr = wrmat;
default{m,1}.searchpath = wrmatpath;
