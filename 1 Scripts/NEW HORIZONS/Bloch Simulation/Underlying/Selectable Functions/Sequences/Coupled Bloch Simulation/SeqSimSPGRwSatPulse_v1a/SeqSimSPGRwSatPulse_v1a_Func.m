...
function [TMTSPGR,err] = TopMTsimSPGR_v1a_Func(TMTSPGR,INPUT)
...
Panel(7,:) = {'TR',SeqPrms.TR,'Output'};
Panel(8,:) = {'NSteady',SeqPrms.NSteady,'Output'};
Panel(9,:) = {'TE',SeqPrms.TE,'Output'};
