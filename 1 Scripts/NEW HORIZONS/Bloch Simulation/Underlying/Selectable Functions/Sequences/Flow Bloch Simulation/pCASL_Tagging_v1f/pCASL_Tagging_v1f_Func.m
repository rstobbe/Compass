...
function [CASL,err] = pCASL_Tagging_v1f_Func(CASL,INPUT)
...
Panel(13,:) = {'','','Output'};
Panel(14,:) = {'SimulationWid (m)',num2str(CASL.simulationwid),'Output'};
Panel(15,:) = {'TimeInSim (ms)',num2str(CASL.timeinsim),'Output'};
Panel(16,:) = {'TimeInSlab (ms)',num2str(CASL.timeinslab),'Output'};
