...
function [SCRPTipt,CASL,err] = pCASL_Tagging3inhomo_v1f(SCRPTipt,CASLipt)
...
CASL.dist2iso = str2double(CASLipt.('Dist2Iso'));
CASL.phaseinc = CASLipt.('PhaseIncPos');
...
CASL.gfix = str2double(CASLipt.('GFix'));
CASL.phasefix = str2double(CASLipt.('PhaseFix'));
