...
function [default] = pCASL_Tagging3inhomo_v1f_Default2(SCRPTPATHS)
...
m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'Dist2Iso (m)';
default{m,1}.entrystr = '0.1';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'PhaseIncPos (deg)';
default{m,1}.entrystr = 'auto';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'delG (mT/m)';
default{m,1}.entrystr = '0';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'delB0 (Hz)';
default{m,1}.entrystr = '0';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'GFix (mT/m)';
default{m,1}.entrystr = '0';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'PhaseFix (deg)';
default{m,1}.entrystr = '0';
