...
function [MTSPGR,err] = MTdesimSPGRwSatPulse2_v1a_Func(MTSPGR,INPUT)
...
trec = linspace(0,SeqPrms.TR-SeqPrms.satrftau-SeqPrms.Del-SeqPrms.exrftau,SimPrms.RecN);
tdel = linspace(0,SeqPrms.Del,SimPrms.RecN);
