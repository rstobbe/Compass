...
function [default] = BlochSim_v1a_Default2(SCRPTPATHS)

if strcmp(filesep,'\')
    seqsimpath = [SCRPTPATHS.newhorizonsloc,'\Bloch Simulation\Underlying\Selectable Functions\Sequences\Bloch Simulation\'];
elseif strcmp(filesep,'/')
end
seqsimfunc = 'SeqSimContSatTest_v1a';
