...
function [SIMDES,err] = MT_EPISE_v1a_Func(SIMDES,INPUT)

Status('busy','Determine MT Spin-Echo EPI Sequence');
Status2('done','',2);
Status2('done','',3);
...
%---------------------------------------------
% Setup DE for Recovery (ignore 180 refocussing)
%---------------------------------------------
RecN = 10;
...
trec = linspace(0,SIMDES.satrfrep-SIMDES.satrftau,RecN);
