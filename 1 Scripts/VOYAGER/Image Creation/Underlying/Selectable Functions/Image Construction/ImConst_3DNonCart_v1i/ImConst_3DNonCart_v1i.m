%=========================================================
% (v1i) 
%   - 'Orient' back in (for Varian)
%=========================================================

function [SCRPTipt,SCRPTGBL,IC,ReturnData,err] = ImConst_3DNonCart_v1i(SCRPTipt,SCRPTGBL,ICipt,FID)
...
% Gridding
%---------------------------------------------
GRD.method = 'GridkSpace_LclKern_v1k';
