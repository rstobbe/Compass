...
function [default] = ImCon3DCartSingle_v1b_Default2(SCRPTPATHS)
...
if strcmp(filesep,'\')
    ...
    filterpath = [SCRPTPATHS.voyagerloc,'Image Processing\Underlying\Selectable Functions\Filter Image\Ringing Removal\'];
...
filterfunc = 'FilterImageKaiser3D_v1a';
zerofillfunc = 'ZeroFill_none_v1a';
orientfunc = 'Orient_none_v1a';
