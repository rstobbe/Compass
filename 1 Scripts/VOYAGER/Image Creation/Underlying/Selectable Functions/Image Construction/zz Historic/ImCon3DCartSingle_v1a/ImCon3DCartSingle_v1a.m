...
function [SCRPTipt,IC,err] = ImCon3DCartSingle_v1a(SCRPTipt,ICipt)
...
IC.kdccorfunc = ICipt.('kDCcorfunc').Func;
...
KDCCORipt = ICipt.('kDCcorfunc');
if isfield(ICipt,([CallingLabel,'_Data']))
    if isfield(ICipt.([CallingLabel,'_Data']),'kDCcorfunc_Data')
        KDCCORipt.('kDCcorfunc_Data') = ICipt.([CallingLabel,'_Data']).('kDCcorfunc_Data');
    end
end
