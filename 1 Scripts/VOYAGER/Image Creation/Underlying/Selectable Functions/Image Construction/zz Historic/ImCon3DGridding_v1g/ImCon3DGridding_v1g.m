%=========================================================
% (v1g) 
%       - start 'ImCon3DGriddingMulti_v1f'
%       - not 'multi' anymore
%       - include rcvr combination (avoid memory limitation)
%=========================================================

function [SCRPTipt,SCRPTGBL,IC,ReturnData,err] = ImCon3DGridding_v1g(SCRPTipt,SCRPTGBL,ICipt)
