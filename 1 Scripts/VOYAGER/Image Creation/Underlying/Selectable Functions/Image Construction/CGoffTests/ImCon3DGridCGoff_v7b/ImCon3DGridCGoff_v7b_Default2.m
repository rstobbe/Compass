...
function [default] = ImCon3DGridCGoff_v7b_Default2(SCRPTPATHS)
...
default{m,1}.labelstr = 'fB0Arr';
default{m,1}.entrystr = '[0.2 0.4 0.5 0.6 0.7 0.75]';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'rErrBrkArr';
default{m,1}.entrystr = '[0.8 0.9 0.9 0.9 0.9 1.0]';
