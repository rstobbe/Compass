...
function [default] = ImCon3DGridCGoff_v2b_Default2(SCRPTPATHS)
...
gridfunc = 'GridkSpace_ExtKern_v1e';
ksampfunc = 'kSampGrdCUDAwOffResE_v1c';
...
m = m+1;
default{m,1}.entrytype = 'RunExtFunc';
default{m,1}.labelstr = 'SDC_File1';
default{m,1}.entrystr = '';
default{m,1}.buttonname = 'Load';
...
m = m+1;
default{m,1}.entrytype = 'RunExtFunc';
default{m,1}.labelstr = 'SDC_File2';
default{m,1}.entrystr = '';
default{m,1}.buttonname = 'Load';
default{m,1}.runfunc1 = 'LoadSDCCur_v4';
default{m,1}.(default{m,1}.runfunc1).curloc = SCRPTPATHS.outloc;
...
default{m,1}.labelstr = 'CGerr_Break';
default{m,1}.entrystr = '1e-5';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'MaxIts';
