...
function [GCGB0,err] = ImCon3DGridCGoff_v2b_Func(GCGB0,INPUT)
...
SDCmat1 = SDCArr2Mat(SDC1,IMP.PROJimp.nproj,IMP.PROJimp.npro);
SDCmat2 = SDCArr2Mat(SDC2,IMP.PROJimp.nproj,IMP.PROJimp.npro);
clear SDC;
