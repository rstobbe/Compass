...
function [GCGB0,err] = ImCon3DGridCGoff_v6a_Func(GCGB0,INPUT)
...
if test == 1
    Imscale = max(abs(Im(:)));
    IMSTRCT.type = 'real'; IMSTRCT.start = 1; IMSTRCT.step = 1; IMSTRCT.stop = Imsz; 
    IMSTRCT.rows = floor(sqrt(Imsz)); IMSTRCT.lvl = [-Imscale Imscale]; IMSTRCT.SLab = 0; IMSTRCT.figno = 1000; 
...
for its = 1:100
    ...
    if test == 1
        IMSTRCT.type = 'real'; IMSTRCT.start = 1; IMSTRCT.step = 1; IMSTRCT.stop = Imsz; 
        IMSTRCT.rows = floor(sqrt(Imsz)); IMSTRCT.lvl = [-Imscale Imscale]; IMSTRCT.SLab = 0; IMSTRCT.figno = 1001; 
        IMSTRCT.docolor = 0; IMSTRCT.ColorMap = 'ColorMap4'; IMSTRCT.figsize = [];
        AxialMontage_v2a(Im,IMSTRCT);
    end
    ...
    if test == 1
        IMSTRCT.type = 'real'; IMSTRCT.start = 1; IMSTRCT.step = 1; IMSTRCT.stop = Imsz; 
        IMSTRCT.rows = floor(sqrt(Imsz)); IMSTRCT.lvl = [-Imscale Imscale]; IMSTRCT.SLab = 0; IMSTRCT.figno = 2000; 
        IMSTRCT.docolor = 0; IMSTRCT.ColorMap = 'ColorMap4'; IMSTRCT.figsize = [];
...
%         IMSTRCT.rows = floor(sqrt(Imsz)); IMSTRCT.lvl = [0 Imscale/10]; IMSTRCT.SLab = 0; IMSTRCT.figno = 2001; 
%         IMSTRCT.docolor = 0; IMSTRCT.ColorMap = 'ColorMap4'; IMSTRCT.figsize = [];
