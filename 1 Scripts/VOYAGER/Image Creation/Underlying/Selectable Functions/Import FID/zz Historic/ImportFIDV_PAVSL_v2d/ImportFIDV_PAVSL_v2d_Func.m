...
function [FID,err] = ImportFIDV_PAVSL_v2d_Func(FID,INPUT)
...
%---------------------------------------------
% Determine Layout for Parameter Structure
%---------------------------------------------
params = {'layout'};
out = Parse_ProcparV_v1a(ProcPar,params);
layout = out{1};
ind = strfind(layout,'RWS_');
layout = layout(ind+4:end);
...
%---------------------------------------------
func = str2func(['CreateParamStructV_',layout]);
