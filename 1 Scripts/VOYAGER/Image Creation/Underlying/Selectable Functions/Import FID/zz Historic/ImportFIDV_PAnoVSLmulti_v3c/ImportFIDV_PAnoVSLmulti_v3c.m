%=========================================================
% (v3c)
%       - v3_ contains 'preprocess' option
%=========================================================

function [SCRPTipt,SCRPTGBL,FID,err] = ImportFIDV_PAnoVSLmulti_v3c(SCRPTipt,SCRPTGBL,FIDipt,RWSUI)
...
FID.preprocfunc = FIDipt.('PreProcfunc').Func;
...
PREPipt = FIDipt.('PreProcfunc');
if isfield(FIDipt,([CallingLabel,'_Data']))
    if isfield(FIDipt.([CallingLabel,'_Data']),'PreProcfunc_Data')
        PREPipt.('PreProcfunc_Data') = FIDipt.([CallingLabel,'_Data']).('PreProcfunc_Data');
    end
end
...
%------------------------------------------
% Get Pre Process Info
%------------------------------------------
func = str2func(FID.preprocfunc);           
