%=========================================================
% (v2e)
%      - same as v2d - 'visuals' option
%=========================================================

function [SCRPTipt,SCRPTGBL,FID,err] = ImportFID_SiemensYBOptionTest_v2e(SCRPTipt,SCRPTGBL,FIDipt)
...
FID.rcvrtest = str2double(FIDipt.('TestReceiver'));
