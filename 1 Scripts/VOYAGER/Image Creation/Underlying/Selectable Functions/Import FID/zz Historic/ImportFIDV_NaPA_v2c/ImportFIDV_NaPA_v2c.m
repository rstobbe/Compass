%=========================================================
% (v2c)
%       - Add DC correction / visualizations
%=========================================================

function [SCRPTipt,FID,err] = ImportFIDV_NaPA_v2c(SCRPTipt,FIDipt,RWSUI)
...
FID.kdccorfunc = FIDipt.('kDCcorfunc').Func;
...
%---------------------------------------------
CallingLabel = FIDipt.Struct.labelstr;
KDCCORipt = FIDipt.('kDCcorfunc');
if isfield(FIDipt,([CallingLabel,'_Data']))
    if isfield(FIDipt.([CallingLabel,'_Data']),'kDCcorfunc_Data')
        KDCCORipt.('kDCcorfunc_Data') = FIDipt.([CallingLabel,'_Data']).('kDCcorfunc_Data');
    end
end
