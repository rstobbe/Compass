%=========================================================
% (v2h)
%      - FoV Shift Capability/Entry
%=========================================================

function [SCRPTipt,SCRPTGBL,FID,err] = ImportFIDV_PAVSL_v2h(SCRPTipt,SCRPTGBL,FIDipt)
...
FID.ShiftLR = str2double(FIDipt.('ShiftLR'));
FID.ShiftTB = str2double(FIDipt.('ShiftTB'));
FID.ShiftIO = str2double(FIDipt.('ShiftIO'));
