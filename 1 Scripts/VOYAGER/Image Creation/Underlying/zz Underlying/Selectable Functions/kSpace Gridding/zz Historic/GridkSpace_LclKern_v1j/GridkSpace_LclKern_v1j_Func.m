...
function [GRD,err] = GridkSpace_LclKern_v1j_Func(GRD,INPUT)
...
%---------------------------------------------
[Ksz,Kx,Ky,Kz,C] = NormProjGrid_v4c(Kmat,nproj,npro,kstep,CONV.chW,SS,'M2A');
clear Kmat
...
if strcmp(GRD.type,'real');
    [GrdDat,err] = mS2GCUDADoubleR_v4g(ZF,Kx,Ky,Kz,KERN,SampDat,CONV,StatLev,COMPASSINFO.CUDA);
elseif strcmp(GRD.type,'complex');
    [GrdDat,err] = mS2GCUDADoubleC_v4g(ZF,Kx,Ky,Kz,KERN,SampDat,CONV,StatLev,COMPASSINFO.CUDA);
end
