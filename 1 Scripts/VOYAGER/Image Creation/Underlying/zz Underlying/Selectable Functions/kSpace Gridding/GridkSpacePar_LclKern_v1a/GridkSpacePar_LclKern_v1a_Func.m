...
function [GRD,err] = GridkSpacePar_LclKern_v1a_Func(GRD,INPUT)
...
if strcmp(GRD.type,'real');
    [GrdDat,err] = mS2GCUDADoubleR_v5a(ZF,Kx,Ky,Kz,KERN,SampDat,CONV,StatLev);
elseif strcmp(GRD.type,'complex');
    [GrdDat,err] = mS2GCUDADoubleC_v5a(ZF,Kx,Ky,Kz,KERN,SampDat,CONV,StatLev);
end
