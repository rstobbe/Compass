...
function [default] = CreateMult3DCart1_v1a_Default2(SCRPTPATHS)
...
importfunc = 'ImportFIDV_gemsme3dR2s_v1a';
dccorfunc = 'DCcor_none_v1a';
preprocfunc = 'PreProc_gemsme3dR2s_v1a';
filterfunc = 'Filter_none_v1a';
rcvcombfunc = 'RcvComb_MultiSuper_v1b';
postprocfunc = 'PostProc_gemsme3dR2s_v1a';
