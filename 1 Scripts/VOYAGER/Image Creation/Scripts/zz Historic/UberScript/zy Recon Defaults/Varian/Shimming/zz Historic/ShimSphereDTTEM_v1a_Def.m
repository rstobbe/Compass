...
function [err] = ShimSphereDTTEM_v1a_Def(IMG,FIDpath,RWSUI,CellArray)
...
%---------------------------------------------
%file.ic = 'IC_ShimSphereDTTEM_v1a.mat';
file.ic = 'IC_ShimSphereDTTEM_v2b.mat';
...
% Setup B0 Shim
%---------------------------------------------
file.prc = 'SHIM_SphereDTTEM_v1a.mat';
