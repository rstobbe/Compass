...
function [err] = NaB0map_v1a_Def(IMG,FIDpath,RWSUI,CellArray)
...
file.ic = ['IC_NaTPI_',projset,'.mat'];
path.ic = [SCRPTPATHS(5).defrootloc,'\VOYAGER\Select\Image Creation\TPI\'];
panelnum.ic = 1;
scrptnum.ic = 1;
...
%---------------------------------------------
file.plt = ['PLT_NaTPI_',projset,'.mat'];
path.plt = [SCRPTPATHS(5).defrootloc,'\VOYAGER\Select\Image Plotting\TPI\'];
panelnum.plt = 2;
scrptnum.plt = 1;
