...
function [SCRPTipt,SCRPTGBL,err] = REAL_Varian_v1a(SCRPTipt,SCRPTGBL)
...
FIDdata = SCRPTipt(strcmp('FIDdata',{SCRPTipt.labelstr})).runfuncoutput{1};

SDC = SCRPTGBL.SDCfile.SDC;
PROJimp = SCRPTGBL.Impfile.PROJimp;
PROJdgn = SCRPTGBL.Impfile.PROJdgn;
Kmat = SCRPTGBL.Impfile.Kmat;

figno = 1;
%------------------------------------------
% Load Data
%------------------------------------------
[Dat] = ImportFIDmatV_v1a([FIDdata,'\fid']);
[Params,errorflag,error] = Load_ParamsV_v1a([SCRPTGBL.File_FIDdata.FIDLoc,'\Params']);
if errorflag == 1
    Status('error',error);
    return
end
