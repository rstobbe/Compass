...
function [SCRPTipt,SCRPTGBL,err] = FidPreload_v1a(SCRPTipt,SCRPTGBL)
...
PLFID.fidrearfunc = SCRPTGBL.CurrentTree.('FidRearrangefunc').Func;
...
FIDRipt = SCRPTGBL.CurrentTree.('FidRearrangefunc');
if isfield(SCRPTGBL,('FidRearrangefunc_Data'))
    FIDRipt.FidRearrangefunc_Data = SCRPTGBL.FidRearrangefunc_Data;
end
...
func = str2func(PLFID.fidrearfunc);           
[SCRPTipt,FIDR,err] = func(SCRPTipt,FIDRipt);
if err.flag
    return
end
