...
function [PLOT,err] = ShimPlot_v1b_Func(PLOT,INPUT)
...
if strcmp(disptype,'DualDispwMask')
    ...
    IMSTRCT.docolor = 1; IMSTRCT.ColorMap = 'ColorMap5'; IMSTRCT.figsize = [500 700];
    ...
    IMSTRCT.docolor = 0; IMSTRCT.ColorMap = 'ColorMap5'; IMSTRCT.figsize = [500 700];
