...
function [ZF,err] = ZeroFill_FactorMaintainPos_v1a_Func(ZF,INPUT)
...
IMG.Im = circshift(IMG.Im,shift(1),1);
IMG.Im = circshift(IMG.Im,shift(2),2);
IMG.Im = circshift(IMG.Im,shift(3),3);
