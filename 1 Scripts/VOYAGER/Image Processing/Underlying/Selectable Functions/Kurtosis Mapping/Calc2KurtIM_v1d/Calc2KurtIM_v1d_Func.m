...
function [CALC,err] = Calc2KurtIM_v1d_Func(CALC,INPUT)
...
% Correct
%---------------------------------------------
func = str2func([CALC.corrfunc,'_Func']);
INPUT.avedwims = avedwims;
INPUT.numaverages = Ndirs * Naves;
[CORR,err] = func(CORR,INPUT);
if err.flag
    return
end
clear INPUT;
avedwims = CORR.cdwims;
CORR = rmfield(CORR,'cdwims');
...
for slice = 1:Nslices
    ...
    figure(2159);
    imshow(squeeze(MK(:,:,slice))*1000,[0 4500]);        
end
