...
function [DISP,err] = DisplayShimHead3TE_v1a_Func(DISP,INPUT)
...
%censW = (-fulldispwid:0.5:fulldispwid);
censW = (-fulldispwid:4:fulldispwid);
...
%censN = (-1.25*maskdispwid:0.25:1.25*maskdispwid);
censN = (-1.25*maskdispwid:2:1.25*maskdispwid);
