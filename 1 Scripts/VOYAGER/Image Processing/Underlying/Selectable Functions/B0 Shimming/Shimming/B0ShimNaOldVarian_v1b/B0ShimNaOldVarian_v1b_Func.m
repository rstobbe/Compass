...
function [SHIM,err] = B0ShimNaOldVarian_v1b_Func(SHIM,INPUT)
...
%--
INPUT.start = 14;                                           % for Varian shim image
INPUT.stop = 56;
INPUT.step = 3;
%--
...
if strcmp(ExtRun,'Yes')
    ...
    INPUT.Name1 = 'Original';
    INPUT.Name2 = 'Regression Residual';
    [~,err] = ShimMapOverlayWithHist_v1a(INPUT);
    if err.flag
        return
    end
    clear INPUT;
