...
function [ROT,err] = ImageRotationRws_v1a_Func(ROT,INPUT)
...
ImReal = Transform3DMatrix_v1c(real(squeeze(IMG.Im(:,:,:,1,1,1))),thx,thy,thz,0,0,0);
ImImag = Transform3DMatrix_v1c(imag(squeeze(IMG.Im(:,:,:,1,1,1))),thx,thy,thz,0,0,0);
