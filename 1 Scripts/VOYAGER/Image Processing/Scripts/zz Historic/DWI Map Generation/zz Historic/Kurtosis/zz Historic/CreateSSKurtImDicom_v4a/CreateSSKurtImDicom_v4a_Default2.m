...
function [default] = CreateSSKurtImDicom_v4a_Default2(SCRPTPATHS)
...
m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'BGoffset';
default{m,1}.entrystr = '31.1';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'StdNoise';
default{m,1}.entrystr = '3.3';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'MinbKurt';
default{m,1}.entrystr = '1500';
