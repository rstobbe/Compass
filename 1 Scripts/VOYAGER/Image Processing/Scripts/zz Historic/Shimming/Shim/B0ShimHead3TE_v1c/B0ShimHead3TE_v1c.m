%===========================================
% (v1c)
%       - (Different mask functions for wide and narrow)
%===========================================

function [SCRPTipt,SCRPTGBL,err] = B0ShimHead3TE_v1c(SCRPTipt,SCRPTGBL)
...
SHIM.maskWfunc = SCRPTGBL.CurrentTree.('MaskWfunc').Func;
SHIM.maskNfunc = SCRPTGBL.CurrentTree.('MaskNfunc').Func;
...
MASKNipt = SCRPTGBL.CurrentTree.('MaskNfunc');
if isfield(SCRPTGBL,('MaskNfunc_Data'))
    MASKNipt.MaskNfunc_Data = SCRPTGBL.MaskNfunc_Data;
end
MASKWipt = SCRPTGBL.CurrentTree.('MaskWfunc');
if isfield(SCRPTGBL,('MaskWfunc_Data'))
    MASKWipt.MaskWfunc_Data = SCRPTGBL.MaskWfunc_Data;
end
...
func = str2func(SHIM.maskNfunc);           
[SCRPTipt,MASKN,err] = func(SCRPTipt,MASKNipt);
if err.flag
    return
end
func = str2func(SHIM.maskWfunc);           
[SCRPTipt,MASKW,err] = func(SCRPTipt,MASKWipt);
if err.flag
    return
end
