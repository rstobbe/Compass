%===========================================
% (v2d)
%       - Separate Into Multiple Functions (cal input to top)
%===========================================

function [SCRPTipt,SCRPTGBL,err] = ShimB0_v2d(SCRPTipt,SCRPTGBL)
...
SHIM.plotfunc = SCRPTGBL.CurrentTree.('Plotfunc').Func;
SHIM.orient = SCRPTGBL.CurrentTree.('Orientation');
SHIM.inset = SCRPTGBL.CurrentTree.('Inset');
SHIM.disporigfullwid = SCRPTGBL.CurrentTree.('DispOrigFull');
SHIM.disporigmaskwid = SCRPTGBL.CurrentTree.('DispOrigMask');
SHIM.dispfitmaskwid = SCRPTGBL.CurrentTree.('DispFitMask');
...
PLTipt = SCRPTGBL.CurrentTree.('Plotfunc');
if isfield(SCRPTGBL,('Plotfunc_Data'))
    PLTipt.Plotfunc_Data = SCRPTGBL.Plotfunc_Data;
end
...
func = str2func(SHIM.plotfunc);
[SCRPTipt,PLT,err] = func(SCRPTipt,PLTipt);
if err.flag
    return
end
