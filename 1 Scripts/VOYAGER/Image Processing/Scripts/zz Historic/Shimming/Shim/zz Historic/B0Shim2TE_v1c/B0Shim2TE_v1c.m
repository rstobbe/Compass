%===========================================
% (v1c)
%     - Image Loading to Function
%     - Facilitate FoV/Voxel Matching
%===========================================

function [SCRPTipt,SCRPTGBL,err] = B0Shim2TE_v1c(SCRPTipt,SCRPTGBL)
...
%--------------------------------------------
if auto == 0;
    name = inputdlg('Name Map:','Name Map',1,{'SHIM'});
    name = cell2mat(name);
    if isempty(name)
