...
function [SCRPTipt,SCRPTGBL,err] = ShimB0_v2b(SCRPTipt,SCRPTGBL)
...
SHIM.writefunc = SCRPTGBL.CurrentTree.('Writefunc').Func;
...
WRTipt = SCRPTGBL.CurrentTree.('Writefunc');
if isfield(SCRPTGBL,('Writefunc_Data'))
    WRTipt.Writefunc_Data = SCRPTGBL.Writefunc_Data;
end
