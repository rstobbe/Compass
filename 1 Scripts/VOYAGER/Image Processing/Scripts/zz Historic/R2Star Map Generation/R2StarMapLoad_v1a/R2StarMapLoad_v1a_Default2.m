...
function [default] = R2StarMapLoad_v1a_Default2(SCRPTPATHS)

if strcmp(filesep,'\')
    calcpath = [SCRPTPATHS.voyagerloc,'Image Processing\Underlying\Selectable Functions\Relaxation Mapping\'];
elseif strcmp(filesep,'/')
end
calcfunc = 'R2Smap_ME_v1a';
...
default{m,1}.labelstr = 'CalcTypefunc';
