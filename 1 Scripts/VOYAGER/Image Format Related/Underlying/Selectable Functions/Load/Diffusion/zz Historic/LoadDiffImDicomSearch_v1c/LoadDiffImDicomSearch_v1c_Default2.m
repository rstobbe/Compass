...
function [default] = LoadDiffImDicomSearch_v1c_Default2(SCRPTPATHS)

m = 1;
default{m,1}.entrytype = 'RunExtFunc';
default{m,1}.labelstr = 'DicomFolder';
...
default{m,1}.labelstr = 'Protocol_Name';
default{m,1}.entrystr = 'Kurt_15dirs_2p5';
