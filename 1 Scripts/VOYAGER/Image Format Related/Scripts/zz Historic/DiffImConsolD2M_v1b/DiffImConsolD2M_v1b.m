...
function [SCRPTipt,SCRPTGBL,err] = DiffImConsolD2M_v1b(SCRPTipt,SCRPTGBL)
...
CSD.averageaves = SCRPTGBL.CurrentTree.('Average_Aves');
CSD.averagedirs = SCRPTGBL.CurrentTree.('Average_Dirs');
