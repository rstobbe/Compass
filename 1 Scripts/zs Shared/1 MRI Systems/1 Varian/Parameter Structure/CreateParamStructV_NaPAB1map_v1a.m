...
function [ExpPars,err] = CreateParamStructV_NaPAB1map_v1a(Text)
...
Sequence.te = str2double(Parse_ParamsV_v1a(Text,[char(10),'te']));
Sequence.fa1 = str2double(Parse_ParamsV_v1a(Text,'flip angle1'));
Sequence.fa2 = str2double(Parse_ParamsV_v1a(Text,'flip angle2'));
...
Sequence.tpwrf1 = str2double(Parse_ParamsV_v1a(Text,'tpwrf1'));
Sequence.tpwrf2 = str2double(Parse_ParamsV_v1a(Text,'tpwrf2'));
Sequence.atpwrf1 = str2double(Parse_ParamsV_v1a(Text,'atpwrf1'));
Sequence.atpwrf2 = str2double(Parse_ParamsV_v1a(Text,'atpwrf2'));
