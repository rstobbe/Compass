function cDirectFTCUDAs_v1b

!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -c -arch sm_35 --ptxas-options="-v" DirectFTCUDAs_v1b.cu
...
mex(['-L' n],'-lcudart','DirectFTCUDAs_v1b.obj','DirectFTCUDAs_v1b.cpp');
