function cFFTCUDASingle_v1a

!"%VS110COMNTOOLS%vcvarsall.bat" amd64 & nvcc -c -arch sm_35 --ptxas-options="-v" FFTCUDASingle_v1a.cu
...
mex(['-L' n],'-lcudart','-lcufft','FFTCUDASingle_v1a.obj','FFTCUDASingle_v1a.cpp');
