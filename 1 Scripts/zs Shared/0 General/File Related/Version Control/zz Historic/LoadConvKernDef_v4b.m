...
function [SCRPTipt,SCRPTGBL,err] = LoadConvKernDef_v4b(SCRPTipt,SCRPTGBL)
...
switch defaultfunc
    case 'Make'
     ...
     case 'Load From' 
        ...
        [file,path] = uigetfile('*.mat','Select Convolution Kernel',defloc);
        if path == 0
            err.flag = 4;
        ...
        SCRPTipt(SCRPTGBL.RWSUI.curpanipt).entrystruct.('LoadConvKernCur_v4b').curloc = path;
