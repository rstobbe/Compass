...
function [SCRPTipt,SCRPTGBL,err] = SelectDataDirDef_v4(SCRPTipt,SCRPTGBL)
...
if isempty(RWSUIGBL.Key)
    ...
    defloc = SCRPTPATHS.(tab)(SCRPTGBL.RWSUI.panelnum).experimentsloc; 
...
switch defaultfunc
     ...
     case 'Load From' 
        ...
        SCRPTipt(SCRPTGBL.RWSUI.curpanipt).entrystruct.('SelectDataDirCur_v4').curloc = loc;
