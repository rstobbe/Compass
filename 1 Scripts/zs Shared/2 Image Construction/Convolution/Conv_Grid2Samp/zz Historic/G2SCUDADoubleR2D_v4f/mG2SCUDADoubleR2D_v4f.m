...
function [Dat,err] = mG2SCUDADoubleR2D_v4f(Ksz,Kx,Ky,KERN,CDat,CONV,StatLev,CUDAdevice)
...
[Dat,Test,Error] = G2SCUDADoubleR2D_v4f(CDat,Kx,Ky,Kern,iKern,chW,chunklen,device,Stathands);
