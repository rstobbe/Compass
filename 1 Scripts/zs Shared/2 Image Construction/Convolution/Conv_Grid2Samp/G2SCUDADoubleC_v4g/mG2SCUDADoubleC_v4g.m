...
function [Dat,err] = mG2SCUDADoubleC_v4g(Ksz,Kx,Ky,Kz,KERN,CDat,CONV,StatLev,CUDAdevice)
...
% Convolve
%------------------------------------
[Dat,Test,Error] = G2SCUDADoubleC_v4g(CDat,Kx,Ky,Kz,Kern,iKern,chW,chunklen,device,Stathands);

%SampDatTest = Dat(100000:100010)
DataSumTest = sum(Dat(:))/1e6
