%==================================================
% (v5c)
%   - mex hack to limit number of GPUs to 2
%==================================================

function [CDat,err] = mS2GCUDADoubleC_v5c(Ksz,Kx,Ky,Kz,KERN,SampDat,CONV,StatLev,CUDA)
...
tic
if ComputeCapability == 6.1 || ComputeCapability == 6.2 
    [CDat,Test,Error] = S2GCUDADoubleC61_v5c(SampDat,Kx,Ky,Kz,Kern,iKern,chW,Ksz,chunklen,Stathands);
elseif ComputeCapability == 7.5
    [CDat,Test,Error] = S2GCUDADoubleC75_v5c(SampDat,Kx,Ky,Kz,Kern,iKern,chW,Ksz,chunklen,Stathands);
end
toc
%Test
