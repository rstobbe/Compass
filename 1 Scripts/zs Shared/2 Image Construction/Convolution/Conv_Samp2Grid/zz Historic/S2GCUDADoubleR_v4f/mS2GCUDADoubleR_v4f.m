...
function [CDat,err] = mS2GCUDADoubleR_v4f(Ksz,Kx,Ky,Kz,KERN,SampDat,CONV,StatLev,CUDAdevice)
...
[CDat,Test,Error] = S2GCUDADoubleR_v4f(SampDat,Kx,Ky,Kz,Kern,iKern,chW,Ksz,chunklen,device,Stathands);
