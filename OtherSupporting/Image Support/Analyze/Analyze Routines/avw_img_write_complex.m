 function avw_img_write_complex(avw, fileprefix, IMGorient, machine, verbose)
 ...
 if ~exist('machine','var'), machine = 'ieee-be'; end
 if ~exist('verbose','var'), verbose = 1; end
 
 if isempty(IMGorient), IMGorient = ''; end
 if isempty(machine), machine = 'ieee-be'; end
 ...
 case  32,
     avw.hdr.dime.bitpix = int16(32); precision = 'single-complex';
 case  64,
