...
function [Ksz,SubSamp,Kx,Ky,Kz,KERN,CONV,err] = ConvSetupTest_v1a(IMP,KRNprms,type)
...
%---------------------------------------------
%[Ksz,Kx,Ky,Kz,C] = NormProjGrid_v4b(Kmat,nproj,npro,kstep,CONV.chW,SubSamp,type);
