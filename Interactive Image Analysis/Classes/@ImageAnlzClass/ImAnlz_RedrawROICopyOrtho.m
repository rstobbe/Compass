...
% New_ROI
%============================================
function IMAGEANLZ = ImAnlz_RedrawROICopyOrtho(IMAGEANLZ,CURRENTROI,TEMPROI,REDRAWROI)
...
IMAGEANLZ.REDRAWROI.CopyRoiInfo(REDRAWROI);
IMAGEANLZ.REDRAWROI.SetDrawOrient(IMAGEANLZ.ORIENT);
