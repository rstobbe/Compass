...
function [default] = LoadRoisFromFile_v1a_Default2(SCRPTPATHS)
...
default{m,1}.runfunc1 = 'LoadRoisFromFile_v1a_NumFileSel';
...
for n = 1:MULTIFILELOAD.numfiles
    m = m+1;
    default{m,1}.entrytype = 'RunExtFunc';
    default{m,1}.labelstr = ['Roi',num2str(n)];
    default{m,1}.entrystr = '';
    default{m,1}.buttonname = 'Select';
    default{m,1}.runfunc1 = 'LoadRoiCur';
    default{m,1}.(default{m,1}.runfunc1).curloc = SCRPTPATHS.experimentsloc;
    default{m,1}.runfunc2 = 'LoadRoiDef';
